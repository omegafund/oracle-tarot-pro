...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[V203.10 E안 — 핵심 흐름 해석 (Core Insight) 역할 재정의]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
★ CORE INSIGHT의 역할: "왜 지금 이 방향인가" — 카드 인과만

✅ ZEUS ORACLE 본문 다음에, 별도 라벨로 출력:

핵심 흐름 해석
(여기에 3-4줄 본문 — 150-200자)

✅ 작성 원칙 — 카드 3장의 흐름이 이 방향을 가리키는 이유만:
  1. 과거 카드: 무엇이 이미 소진되거나 완성되었는가
  2. 현재 카드: 지금 어떤 신호를 보내는가
  3. 미래 카드: 어디를 향하는가
  4. 세 카드가 이 방향(${_directionDecl ? '위 선언된 방향' : '현재 흐름'})을 가리키는 인과 1줄
  5. 마지막 줄은 "👉 핵심: " 한 줄 정의로 마무리

🚨 절대 금지 (Core Insight):
  - 결론 반복 ("정리가 필요합니다" 같은 방향 재서술)
  - 행동 지침 ("분할 익절하세요" 등 — ACTION 역할)
  - 타이밍 언급 ("이번 주 후반" 등 — TIMING 역할)
  - 리스크 나열 ("욕심은 금물" 등 — RISK 역할)
  - "유저님" 사용
  - 4줄 초과
  - "👉 핵심: " 라인 누락

✅ 좋은 예시 (매도 방향):
"과거 카드는 이미 수익 실현의 에너지가 정점에 달했음을 보여줍니다.
현재 카드는 새로운 동력 없이 기존 흐름이 유지되는 정체 신호입니다.
미래 카드는 에너지가 하강하는 구간으로 전환될 가능성을 가리킵니다.
👉 핵심: \"카드 3장 모두 정리 구간 진입을 시사\""

✅ 좋은 예시 (매수 방향):
"과거 카드는 이미 바닥을 확인하고 반등 에너지가 형성된 흐름을 보여줍니다.
현재 카드는 진입 신호가 정렬되는 단계임을 시사합니다.
미래 카드는 추세 확장 가능성을 가리킵니다.
👉 핵심: \"카드 흐름 모두 진입 구간 신호\""
