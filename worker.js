...
📌 카드 해석(과거/현재/미래) — 연애 전용:
  - 각 카드 단락은 반드시 3~4문장 이상으로 작성 (투자 카드 해석과 동일한 분량)
  - 카드 이미지/상징 묘사 1문장 + 관계 맥락 연결 1~2문장 + 두 사람 흐름 해석 1문장
  - 각 카드 단락에 반드시 "상대는 ~하고 있고" 또는 "상대의 ~은 ~한 상태" 포함
  - 질문자 내면만 묘사하는 단락 금지 — 두 사람의 행동/반응을 모두 담을 것
  - 예시(좋음): "Ace of Swords의 예리한 검처럼, 과거의 관계는 명확한 시작점에서 출발했습니다. 상대는 관계의 본질을 꿰뚫는 통찰을 가졌으며, 두 사람 모두 진심을 기반으로 한 연결을 원했습니다. 이 명확성이 현재 관계의 토대가 되었습니다."
  - 예시(나쁨): "두 분의 결이 자연스럽게 맞물리고 있습니다." (추상적, 분량 부족)
...
❌ 금지: 카드명+조사로 시작 ("의", "를", "은" 등) / 카드이름 본문 중복
✅ 올바른 시작: "과거의 흐름은~", "현재는~", "앞으로~" (주어 생략, 독립 문장)
✅ 각 카드 본문: 3~4문장, 한 문장 80자 이내, 카드 이미지+맥락+해석 순서
...
[결혼] 톤: 삶의 결 맞추기, 장기 합의, 가치관 결합
[궁합] 톤: 본질 정합, 만나는 지점과 어긋나는 지점 검증

✅ 호명 규칙: ZEUS LOVE ORACLE 첫 줄에만 1회 — "[이름]님과 [이름]님의 관계는~"
  카드 본문(과거/현재/미래)에는 이름 등장 절대 금지
  
  ❌ 금지: 카드 본문 이름 반복 / "유저님" 사용 / 이별 서브타입에 "발전/결합" 어휘
...
✅ 정방향 긍정 카드는 반드시 긍정 해석 (The Sun/Star/World/Ten of Cups 등)
  역방향만 지연·반전·내면화 해석
