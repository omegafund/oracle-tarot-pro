...
function corsHeaders() {
  return {
    ...
    // [V202.7] ★ 와일드카드 ★ 적용 — 제미나이 진단 채택:
    //          "preflight 통과 보장 + 모든 헤더 허용"
    //          이유: index.html이 fetch 시 어떤 헤더든 보내도 차단 X
    //          + Max-Age 24시간 (preflight 캐시 → 재요청 시 OPTIONS 생략)
...
// ══════════════════════════════════════════════════════════════════
// [V203.12] CARD_SENTENCE_POOL — 상위 30장 포지션별 4문장
//   설계: 카드 해시 + 질문 텍스트 해시 조합 → 같은 카드도 질문마다 다른 문장
//   폴백: CARD_TAG 기반 자동 생성 (나머지 48장)
// ══════════════════════════════════════════════════════════════════
const CARD_SENTENCE_POOL = {
  "The Fool": {
    past:    ["과거에는 준비 없이 뛰어들었던 에너지가 흐름의 출발점이 됐습니다.","리스크를 인지하지 못한 채 시작했던 흔적이 남아있습니다.","새로운 시도의 열정이 있었지만 방향이 불분명했습니다.","기대감이 앞섰던 시기였습니다."],
    present: ["지금은 방향이 불명확한 채로 새 시작이 진행되고 있습니다.","확신 없는 진입 에너지가 작동하고 있습니다.","새로운 흐름이 시작됐지만 리스크 인지가 부족합니다.","기대와 불안이 공존하는 초입 단계입니다."],
    future:  ["앞으로는 용기 있는 첫 걸음이 필요한 시점이 옵니다.","새로운 시작의 기회가 열리지만 준비가 선행돼야 합니다.","무모함보다 의도적인 도전이 흐름을 바꿀 것입니다.","다음 단계는 새 출발의 결단에 달려있습니다."]
  },
  "The Magician": {
    past:    ["준비는 충분했지만 실행 타이밍이 늦어졌습니다.","아이디어는 있었지만 행동으로 이어지지 못했습니다.","기회는 보였지만 확신 부족이 발목을 잡았습니다.","실행력이 내면에 머물렀던 시기였습니다."],
    present: ["지금은 실행 의지가 강하게 작동하는 구간입니다.","모든 도구가 갖춰진 상태에서 행동이 요구됩니다.","실행력이 흐름을 주도하고 있습니다.","의지와 타이밍이 맞아떨어지는 시점입니다."],
    future:  ["앞으로는 준비된 실행이 결과를 만들어냅니다.","타이밍을 놓치지 않는 결단이 흐름을 바꿉니다.","실행 에너지가 정점에 도달하는 구간이 옵니다.","행동하는 자에게 기회가 열립니다."]
  },
  "The High Priestess": {
    past:    ["직관이 신호를 보내고 있었지만 무시됐던 시기입니다.","내면의 경고가 있었으나 행동으로 이어지지 않았습니다.","겉으로 드러나지 않은 흐름이 형성되던 때였습니다.","기다림이 길었던 관망의 시기였습니다."],
    present: ["지금은 드러나지 않은 정보가 흐름을 좌우하고 있습니다.","직관적 신호에 귀 기울여야 할 시점입니다.","표면보다 이면의 흐름이 중요한 구간입니다.","섣부른 판단보다 관망이 더 현명한 시점입니다."],
    future:  ["앞으로 숨겨진 정보가 서서히 드러날 것입니다.","기다림이 명확성을 가져오는 시점이 옵니다.","내면의 신호가 방향을 알려줄 것입니다.","시간이 흐름의 본질을 드러냅니다."]
  },
  "The Tower": {
    past:    ["과거에는 예상치 못한 충격이 기반을 흔들었습니다.","급격한 변화가 기존 구조를 무너뜨렸던 시기였습니다.","충격적인 전환점이 있었고 그 여파가 지금까지 이어집니다.","한순간에 흐름이 뒤바뀐 경험이 있었습니다."],
    present: ["지금은 급격한 변화가 진행 중인 불안정 구간입니다.","예측 불가능한 충격 에너지가 작동하고 있습니다.","기존 구조가 흔들리는 전환점입니다.","포지션 점검이 시급한 시점입니다."],
    future:  ["앞으로 예상치 못한 충격이 흐름을 바꿀 수 있습니다.","급격한 변동성 구간이 다가오고 있습니다.","충격을 대비한 리스크 관리가 선행돼야 합니다.","변화에 유연하게 대응하는 전략이 필요합니다."]
  },
  "The Moon": {
    past:    ["불분명한 신호가 판단을 흐렸던 시기였습니다.","착시와 불안이 공존하던 모호한 국면이었습니다.","표면과 실제가 달랐던 혼란스러운 흐름이었습니다.","방향이 보이지 않았던 불확실성의 시기였습니다."],
    present: ["지금은 정보 모호함이 판단을 방해하고 있습니다.","표면 신호를 그대로 믿기 어려운 구간입니다.","착시 가능성이 높은 불안정한 흐름입니다.","신중한 검증이 그 어느 때보다 중요한 시점입니다."],
    future:  ["앞으로 불확실성이 고조되는 구간이 옵니다.","숨겨진 변수가 드러나며 흐름이 바뀔 수 있습니다.","착시에 주의해야 하는 구간이 다가오고 있습니다.","명확성이 회복되기까지 시간이 필요합니다."]
  },
  "The Sun": {
    past:    ["긍정적인 에너지가 흐름의 기반을 만들었습니다.","명확성과 자신감이 출발점이 됐습니다.","성과가 쌓이던 밝은 흐름의 시기였습니다.","확신 에너지가 강했던 시기였습니다."],
    present: ["지금은 흐름이 명확하게 드러나는 시점입니다.","긍정적 에너지가 시장을 주도하고 있습니다.","확신과 성과가 교차하는 구간입니다.","방향이 뚜렷해지는 전환점입니다."],
    future:  ["앞으로 흐름이 밝아지는 구간이 열립니다.","명확한 성과가 드러나는 시점이 옵니다.","긍정적 돌파의 기회가 다가오고 있습니다.","확신을 가지고 나아갈 수 있는 흐름입니다."]
  },
  "The Devil": {
    past:    ["욕심이나 집착이 판단을 흐렸던 시기였습니다.","손실 이후에도 자리를 지켰던 의존적 흐름이었습니다.","감정적 집착이 냉철한 판단을 막았습니다.","빠져나오기 어려운 구조에 묶여있던 때였습니다."],
    present: ["지금은 집착이나 욕심이 흐름을 왜곡하고 있습니다.","감정적 의존이 냉정한 판단을 방해하고 있습니다.","빠져나오기 어려운 심리적 구조가 작동 중입니다.","탐욕과 냉철함 사이의 균형이 요구됩니다."],
    future:  ["앞으로 집착에서 벗어나는 것이 핵심 과제가 됩니다.","욕심이 판단을 흐리는 구간이 다가오고 있습니다.","감정적 의존을 끊어내는 결단이 필요합니다.","냉철한 기준 없이는 손실이 확대될 수 있습니다."]
  },
  "Judgement": {
    past:    ["재평가와 각성의 순간이 흐름의 전환점이 됐습니다.","과거를 돌아보고 새 방향을 설정했던 시기였습니다.","중요한 깨달음이 있었던 전환의 시기였습니다.","내면의 각성이 시작됐던 때였습니다."],
    present: ["지금은 전면적인 재평가가 진행 중입니다.","새로운 각도로 흐름을 바라봐야 할 시점입니다.","과거를 청산하고 새 출발을 준비하는 구간입니다.","중요한 결정을 앞둔 각성의 시점입니다."],
    future:  ["앞으로 새로운 시작의 신호가 분명해집니다.","재평가 이후 더 나은 방향이 열립니다.","결정적인 전환점이 다가오고 있습니다.","과거의 짐을 내려놓는 순간이 옵니다."]
  },
  "Wheel of Fortune": {
    past:    ["순환의 에너지가 흐름을 바꿨던 전환점이 있었습니다.","예상치 못한 방향 전환이 있었던 시기였습니다.","운의 흐름이 크게 변했던 때였습니다.","사이클의 전환이 기회 또는 위기를 만들었습니다."],
    present: ["지금은 흐름의 전환이 진행 중인 구간입니다.","사이클의 변곡점에 있습니다.","방향이 바뀌는 흐름의 중심에 있습니다.","운의 흐름이 달라지고 있는 시점입니다."],
    future:  ["앞으로 흐름의 사이클이 크게 전환됩니다.","새로운 국면이 열리는 변곡점이 옵니다.","흐름의 방향이 명확해지는 시점이 다가옵니다.","사이클의 전환을 기회로 활용해야 합니다."]
  },
  "The Hanged Man": {
    past:    ["결정을 미루며 관망하던 정체의 시기였습니다.","다른 관점이 필요했지만 행동이 지연됐습니다.","기다림이 길었고 흐름이 멈춰있던 때였습니다.","내면의 재정립이 필요했던 보류의 시기였습니다."],
    present: ["지금은 결정을 미루고 있는 정체 구간입니다.","새로운 관점이 필요하지만 행동이 막혀있습니다.","기다림이 필요한 시점이지만 이유를 명확히 해야 합니다.","현재 흐름은 의도적인 관망을 요구합니다."],
    future:  ["앞으로 결정의 시점이 반드시 옵니다.","보류 이후 더 명확한 방향이 열립니다.","기다림이 끝나는 시점에 행동이 필요합니다.","새로운 관점이 돌파구를 만들어줄 것입니다."]
  },
  "Seven of Swords": {
    past:    ["정보 비대칭이 판단을 흐렸던 시기였습니다.","중요한 신호를 놓쳤거나 은폐된 요소가 있었습니다.","불확실한 정보 속에서 결정이 이루어졌습니다.","신뢰하기 어려운 흐름이 있었던 때였습니다."],
    present: ["시장은 아직 모든 정보를 드러내지 않고 있습니다.","겉으로 보이는 신호보다 숨은 변수에 주의가 필요합니다.","정보 비대칭이 존재하는 구간입니다.","검증되지 않은 기대가 섞여 있는 흐름입니다."],
    future:  ["앞으로 숨겨진 변수가 서서히 드러날 것입니다.","정보가 불투명해지는 구간이 다가오고 있습니다.","표면 신호를 맹신하지 않는 냉정함이 필요합니다.","숨은 리스크가 현실화되는 시점에 대비해야 합니다."]
  },
  "Five of Swords": {
    past:    ["갈등이 남긴 상처가 관계의 흐름에 영향을 미쳤습니다.","이긴 싸움이었지만 양쪽 모두 소모된 흔적이 있습니다.","자존심 대결이 진짜 문제를 가린 시기였습니다.","충돌 이후 회복이 필요했던 때였습니다."],
    present: ["지금은 자존심 충돌이 흐름을 방해하고 있습니다.","승패를 가리기보다 관계 자체를 돌봐야 할 시점입니다.","갈등의 잔재가 소통을 막고 있습니다.","이기는 것보다 지속하는 것이 중요한 구간입니다."],
    future:  ["앞으로 충돌보다 화해가 더 나은 결과를 만듭니다.","자존심을 내려놓는 순간 흐름이 바뀝니다.","갈등을 넘어서는 것이 다음 단계의 열쇠입니다.","상처를 봉합하는 대화가 필요한 시점이 옵니다."]
  },
  "Ten of Swords": {
    past:    ["바닥을 경험하며 더 이상 내려갈 곳이 없음을 확인했습니다.","극한의 어려움이 새로운 시작의 토대가 됐습니다.","고통스러운 종결이 있었지만 그것이 전환점이 됐습니다.","최악의 국면을 지나온 흔적이 남아있습니다."],
    present: ["지금은 바닥 확인이 진행 중인 종결 구간입니다.","더 이상 하락하기 어려운 바닥 에너지가 작동합니다.","고통스럽지만 전환의 씨앗이 심어지고 있습니다.","현재 국면은 끝이자 새 시작의 경계입니다."],
    future:  ["앞으로 바닥 이후 회복의 흐름이 시작됩니다.","종결 이후 새로운 에너지가 유입됩니다.","최악을 지나면 반드시 방향이 생깁니다.","회복의 첫 신호를 놓치지 않는 것이 중요합니다."]
  },
  "Ace of Swords": {
    past:    ["명확한 결단이 있었던 흐름의 전환점이 있었습니다.","진실을 직시하는 에너지가 시작됐던 시기였습니다.","새로운 기준이 세워지던 명확성의 출발점이었습니다.","돌파의 에너지가 형성됐던 때였습니다."],
    present: ["지금은 명확한 결단이 요구되는 시점입니다.","진실과 마주하는 에너지가 작동하고 있습니다.","새로운 기준을 세워야 하는 전환점입니다.","모호함을 끝내고 방향을 확정해야 할 시점입니다."],
    future:  ["앞으로 명확한 결론이 도출되는 시점이 옵니다.","진실이 드러나며 방향이 확정됩니다.","결단의 순간이 다가오고 있습니다.","명확성이 회복되며 돌파구가 열립니다."]
  },
  "The Star": {
    past:    ["희망과 회복의 에너지가 바닥을 지나며 형성됐습니다.","어두운 시기 이후 빛이 보이기 시작했던 때였습니다.","회복의 씨앗이 심어졌던 시기였습니다.","저점 이후 새로운 가능성이 열렸던 흐름이었습니다."],
    present: ["지금은 회복과 희망의 에너지가 흐름에 유입되고 있습니다.","저점을 통과하며 긍정적 흐름이 형성되고 있습니다.","치유와 회복의 과정이 진행 중입니다.","앞으로 나아갈 방향이 서서히 보이기 시작합니다."],
    future:  ["앞으로 회복이 가시화되는 흐름이 열립니다.","희망이 현실이 되는 구간이 다가오고 있습니다.","저점 이후 지속적인 회복 흐름이 형성됩니다.","인내 이후 결실이 맺히는 시점이 옵니다."]
  },
  "Queen of Wands": {
    past:    ["자신감과 장악력이 흐름을 주도했던 시기였습니다.","강한 에너지로 관계나 시장을 이끌었던 때였습니다.","확신에 찬 진입 에너지가 출발점이 됐습니다.","매력적인 흐름이 형성됐던 시기였습니다."],
    present: ["지금은 자신감 있는 에너지가 흐름을 장악하고 있습니다.","강한 매력과 확신이 흐름을 이끌고 있습니다.","적극적인 에너지가 관계나 시장을 주도합니다.","지금이 행동하기에 유리한 에너지 구간입니다."],
    future:  ["앞으로 자신감 있는 흐름이 결과를 만들어냅니다.","강한 에너지가 다음 단계를 열어줄 것입니다.","확신을 가지고 나아가는 자에게 기회가 옵니다.","리더십 있는 접근이 흐름을 바꿉니다."]
  },
  "King of Cups": {
    past:    ["감정을 통제하며 균형을 유지했던 흐름이었습니다.","평정심이 관계나 판단의 기반이 됐던 시기였습니다.","감성적 성숙이 흐름을 이끌었습니다.","냉정함과 감성의 균형이 작동했던 때였습니다."],
    present: ["지금은 감정 통제와 평정심이 핵심 에너지입니다.","흔들리지 않는 균형감이 흐름을 지탱하고 있습니다.","감성적 안정감이 판단의 기준이 됩니다.","조급함보다 여유로운 관망이 필요한 시점입니다."],
    future:  ["앞으로 감정적 성숙이 흐름의 전환점이 됩니다.","평정심을 유지하는 것이 결과를 좌우합니다.","안정적인 흐름이 지속되는 구간이 형성됩니다.","감성적 지혜가 다음 단계를 이끌 것입니다."]
  },
  "Ace of Cups": {
    past:    ["새로운 감정적 시작이 흐름의 출발점이 됐습니다.","긍정적 기대감이 유입됐던 시기였습니다.","감성적 전환의 씨앗이 심어진 때였습니다.","신선한 에너지가 흐름을 바꿨습니다."],
    present: ["새로운 기대가 시장 심리를 자극하고 있습니다.","관심이 유입되며 분위기가 바뀌고 있습니다.","감정적 낙관론이 형성되는 초기 단계입니다.","신선한 흐름이 시작됐지만 과잉 낙관에 주의가 필요합니다."],
    future:  ["앞으로 새로운 감성적 기회가 열립니다.","긍정적 흐름이 가시화되는 구간이 옵니다.","감정적 전환이 결과로 이어지는 시점이 다가옵니다.","새 출발의 에너지가 결실을 맺습니다."]
  },
  "Eight of Wands": {
    past:    ["빠른 전개가 흐름을 이끌었던 시기였습니다.","급속한 진행이 있었던 에너지의 시기였습니다.","빠른 결정과 행동이 흐름을 만들었습니다.","단기 과열이 있었던 때였습니다."],
    present: ["지금은 흐름이 빠르게 전개되고 있습니다.","단기 과열 가능성이 있는 급속 전개 구간입니다.","빠른 진입이 요구되는 에너지가 작동합니다.","속도감 있는 흐름이 이어지고 있습니다."],
    future:  ["앞으로 빠른 전개가 기회를 만들어냅니다.","급속한 흐름 변화가 다가오고 있습니다.","타이밍을 놓치지 않는 빠른 판단이 필요합니다.","에너지가 정점에 도달하는 구간이 옵니다."]
  },
  "Three of Swords": {
    past:    ["상처와 충격이 있었던 흐름이었습니다.","예상치 못한 손실이나 고통이 있었던 시기였습니다.","감정적 타격이 판단에 영향을 미쳤습니다.","아픔이 새로운 방향의 계기가 됐습니다."],
    present: ["지금은 충격이나 상처 에너지가 흐름에 작용합니다.","손실 가능성이 있는 불안정한 구간입니다.","감정적 충격에 대비해야 하는 시점입니다.","현실을 냉정하게 직시해야 하는 구간입니다."],
    future:  ["앞으로 충격적인 변화가 흐름을 바꿀 수 있습니다.","손실 에너지가 현실화되는 시점에 대비해야 합니다.","아픔 이후 회복의 흐름이 시작됩니다.","어려운 진실을 마주하는 순간이 옵니다."]
  },
  "Four of Swords": {
    past:    ["관망과 휴식이 필요했던 에너지 재충전의 시기였습니다.","적극적 행동보다 기다림이 선택됐던 때였습니다.","에너지를 비축했던 전략적 관망의 시기였습니다.","잠시 물러서 흐름을 살폈던 때였습니다."],
    present: ["지금은 에너지를 재충전해야 하는 관망 구간입니다.","적극적 행동보다 기다림이 더 현명한 시점입니다.","전략적 휴식이 다음 행동을 준비합니다.","흐름을 지켜보는 인내가 필요합니다."],
    future:  ["앞으로 충분한 준비 이후 행동의 시점이 옵니다.","관망이 끝나고 행동의 기회가 열립니다.","에너지 재충전 이후 강한 흐름이 형성됩니다.","기다림이 최선의 전략인 구간이 지나갑니다."]
  },
  "Nine of Swords": {
    past:    ["과도한 걱정과 불안이 판단을 방해했던 시기였습니다.","심리적 압박이 실제보다 크게 느껴졌던 때였습니다.","불안이 현실을 왜곡했던 흐름이었습니다.","두려움이 행동을 막았던 시기였습니다."],
    present: ["지금은 심리적 불안이 흐름을 왜곡하고 있습니다.","실제 위험보다 심리적 압박이 더 크게 작용합니다.","두려움과 냉철함을 구분해야 하는 시점입니다.","과도한 걱정이 판단을 흐리고 있습니다."],
    future:  ["앞으로 심리적 압박을 넘어서는 구간이 옵니다.","불안이 걷히며 현실이 명확해집니다.","두려움을 직면하는 것이 돌파구가 됩니다.","심리적 안정을 찾는 것이 다음 단계의 핵심입니다."]
  },
  "Five of Pentacles": {
    past:    ["어려움과 손실이 있었던 시기였습니다.","지원이 부족하거나 고립감이 있었던 때였습니다.","회복이 필요했던 어려운 국면이었습니다.","손실 이후 재건이 시작됐던 흐름이었습니다."],
    present: ["지금은 손실이나 어려움이 실재하는 구간입니다.","도움을 요청하거나 지원을 찾아야 할 시점입니다.","현실적인 어려움을 직시해야 하는 흐름입니다.","비용 관리와 손실 제한이 중요한 구간입니다."],
    future:  ["앞으로 어려움이 지나가는 회복의 흐름이 옵니다.","손실 이후 재건의 기회가 열립니다.","지원을 찾는 것이 회복을 앞당깁니다.","어려운 시기가 지나면 더 강한 흐름이 형성됩니다."]
  },
  "Seven of Pentacles": {
    past:    ["인내하며 결과를 기다렸던 장기 투자의 시기였습니다.","꾸준한 노력이 쌓였던 때였습니다.","성과를 평가하고 방향을 재점검했던 시기였습니다.","기다림이 이어졌던 흐름이었습니다."],
    present: ["지금은 결과를 평가하고 방향을 재점검할 시점입니다.","인내가 필요한 장기 관망 구간입니다.","현재 투자의 성과를 냉정하게 평가해야 합니다.","기다림과 행동 사이의 균형이 필요한 시점입니다."],
    future:  ["앞으로 인내한 결실이 드러나는 시점이 옵니다.","꾸준함이 성과로 이어지는 흐름이 형성됩니다.","장기적 관점이 보상받는 구간이 옵니다.","기다림이 끝나고 수확의 시점이 다가옵니다."]
  },
  "Six of Pentacles": {
    past:    ["균형 잡힌 교류와 호의가 흐름의 기반이 됐습니다.","주고받음의 균형이 관계를 안정시켰던 시기였습니다.","공정한 분배가 이루어졌던 때였습니다.","상호 호혜적 흐름이 있었습니다."],
    present: ["지금은 균형 잡힌 접근이 가장 효과적인 구간입니다.","주고받음의 조화가 흐름을 이끌고 있습니다.","공정한 판단이 결과를 만들어냅니다.","분산과 균형이 안정적인 흐름을 만듭니다."],
    future:  ["앞으로 균형 잡힌 결과가 도출되는 흐름입니다.","공정한 교환이 이루어지는 구간이 옵니다.","주고받음의 흐름이 다음 단계를 만들어냅니다.","균형이 회복되며 안정이 찾아옵니다."]
  },
  "Queen of Cups": {
    past:    ["직관과 공감이 흐름의 중심이었던 시기였습니다.","감성적 통찰이 판단을 이끌었습니다.","내면의 소리에 귀 기울였던 때였습니다.","섬세한 감성이 관계를 만들었습니다."],
    present: ["지금은 직관적 신호가 중요한 정보를 담고 있습니다.","감성적 공감이 흐름을 주도하고 있습니다.","논리보다 직관이 더 나은 판단을 이끕니다.","내면의 소리를 믿어야 하는 시점입니다."],
    future:  ["앞으로 감성적 통찰이 방향을 알려줄 것입니다.","직관이 맞아떨어지는 흐름이 형성됩니다.","공감 능력이 다음 단계의 열쇠가 됩니다.","내면의 지혜가 결과를 만들어냅니다."]
  },
  "The Empress": {
    past:    ["풍요와 성장의 에너지가 기반을 만들었습니다.","자연스러운 확장이 이루어졌던 시기였습니다.","풍성한 흐름이 결실을 준비했던 때였습니다.","창조적 에너지가 강했던 시기였습니다."],
    present: ["지금은 성장과 풍요의 에너지가 흐름에 작용합니다.","자연스러운 확장이 진행 중입니다.","풍성한 기회가 형성되고 있는 구간입니다.","성장 에너지를 적극적으로 활용해야 합니다."],
    future:  ["앞으로 풍요로운 결실이 드러나는 흐름입니다.","성장이 가시화되는 구간이 다가옵니다.","자연스러운 확장이 결과로 이어집니다.","창조적 에너지가 꽃피는 시점이 옵니다."]
  },
  "Five of Wands": {
    past:    ["경쟁과 혼란이 방향성을 흐렸던 시기였습니다.","다양한 의견이 충돌하며 명확한 결론이 나지 않았습니다.","노이즈가 많아 핵심 신호를 구분하기 어려웠습니다.","여러 흐름이 교차하며 판단을 어렵게 만들었습니다."],
    present: ["지금은 다양한 힘이 충돌하며 방향이 불명확한 구간입니다.","경쟁적 에너지가 흐름을 복잡하게 만들고 있습니다.","노이즈 속에서 자신의 기준을 유지해야 하는 시점입니다.","밀고 당기기가 반복되는 탐색의 구간입니다."],
    future:  ["앞으로 경쟁이 정리되며 방향이 명확해집니다.","혼란이 지나가면 진짜 신호가 드러납니다.","자신의 기준을 잃지 않으면 기회를 잡을 수 있습니다.","경쟁 구간을 넘어서는 명확한 결단이 필요합니다."]
  },
  "Two of Wands": {
    past:    ["계획을 세우고 가능성을 탐색했던 관망의 시기였습니다.","다음 행동을 준비하며 전략을 수립했던 흐름이었습니다.","방향을 결정하기 전 다양한 선택지를 검토했습니다.","기회를 발견했지만 아직 움직이지 않았던 때였습니다."],
    present: ["지금은 방향을 설정하고 다음 행동을 준비해야 할 시점입니다.","가능성은 보이지만 결단이 필요한 전환점입니다.","계획 단계에서 실행 단계로 전환이 요구됩니다.","두 가지 방향 사이에서 선택을 준비하는 구간입니다."],
    future:  ["앞으로 준비한 방향으로 나아가는 실행의 시점이 옵니다.","계획이 현실이 되는 흐름이 형성됩니다.","결단을 내리면 새로운 흐름이 시작됩니다.","준비된 방향이 결과를 만들어냅니다."]
  },
  "Three of Wands": {
    past:    ["확장의 가능성이 보였지만 아직 결실은 아니었던 시기였습니다.","먼 곳을 바라보며 장기적 흐름을 준비했습니다.","기회가 열렸지만 인내가 필요했던 때였습니다.","중장기 관점에서 기반을 다졌던 흐름이었습니다."],
    present: ["지금은 중장기 관점에서 흐름을 바라봐야 할 시점입니다.","확장의 가능성이 가시화되고 있는 구간입니다.","기회는 보이지만 실현까지 기다림이 필요합니다.","전략적 시야를 넓혀야 하는 흐름입니다."],
    future:  ["앞으로 확장과 기회가 현실이 되는 흐름이 옵니다.","중장기 준비가 결실을 맺는 시점이 다가옵니다.","멀리 바라봤던 것들이 손에 잡히기 시작합니다.","인내한 흐름이 확장으로 이어집니다."]
  },
  "Eight of Pentacles": {
    past:    ["꾸준한 노력과 기술 축적이 현재의 기반을 만들었습니다.","성실한 작업이 포지션을 견고하게 다졌습니다.","단계적 성과가 쌓였던 시기였습니다.","숙련도가 높아지며 안정적 흐름이 형성됐습니다."],
    present: ["지금은 꾸준한 성과 축적이 진행 중인 견고한 구간입니다.","기술과 노력이 결과로 이어지고 있습니다.","안정적인 흐름이 지속되고 있지만 정점도 가까워지고 있습니다.","현재의 견고함 속에서 다음 전환을 준비해야 합니다."],
    future:  ["앞으로 축적된 노력이 명확한 성과로 드러납니다.","꾸준함이 보상받는 흐름이 형성됩니다.","기술과 성실함이 결실을 맺는 시점이 옵니다.","단계적 성과가 완성되는 흐름입니다."]
  },
  "The Chariot": {
    past:    ["강한 추진력이 흐름을 이끌었던 시기였습니다.","목표를 향해 돌진했던 에너지의 시기였습니다.","장애물을 극복하며 전진했던 흐름이었습니다.","승리를 향한 강한 의지가 출발점이 됐습니다."],
    present: ["지금은 강한 모멘텀이 흐름을 주도하고 있습니다.","목표를 향해 직진하는 에너지가 작동합니다.","흔들리지 않는 집중력이 결과를 만들어냅니다.","추진력을 잃지 않으면 목표에 도달할 수 있습니다."],
    future:  ["앞으로 강한 돌파력이 장애물을 넘어설 것입니다.","목표 달성의 흐름이 강하게 형성됩니다.","집중과 의지가 승리를 만들어냅니다.","돌파의 순간이 다가오고 있습니다."]
  },
  "King of Wands": {
    past:    ["리더십과 비전이 흐름을 주도했던 시기였습니다.","확고한 방향성이 출발점이 됐습니다.","강한 의지와 카리스마가 에너지를 만들었습니다.","장기적 목표를 향한 의지가 강했던 때였습니다."],
    present: ["지금은 확고한 방향과 리더십이 흐름을 이끌고 있습니다.","비전을 가진 접근이 최선의 결과를 만들어냅니다.","강한 의지로 흐름을 주도해야 하는 시점입니다.","장기적 관점의 리더십이 요구됩니다."],
    future:  ["앞으로 강력한 리더십이 흐름의 방향을 결정합니다.","비전이 현실이 되는 흐름이 형성됩니다.","확고한 의지가 결과를 만들어냅니다.","장기적 목표가 달성되는 흐름이 옵니다."]
  },
  "The World": {
    past:    ["하나의 사이클이 완성됐던 정점의 시기였습니다.","목표가 달성되며 에너지가 통합됐던 때였습니다.","완성의 흐름이 지나온 경로의 절정이었습니다.","그동안의 노력이 결실을 맺었던 시기였습니다."],
    present: ["지금은 하나의 사이클이 완성되는 정점 구간입니다.","완성 에너지가 강할수록 신규 진입 매력은 줄어듭니다.","현재의 성취감은 높지만 다음 국면 전환이 다가오고 있습니다.","완성 이후의 방향을 고민해야 하는 전환점입니다."],
    future:  ["앞으로 하나의 흐름이 완성되며 새 사이클이 시작됩니다.","완성 이후 새로운 목표를 설정해야 하는 시점이 옵니다.","사이클의 끝이자 새 시작의 에너지가 형성됩니다.","통합과 완성의 에너지가 다음 단계를 열어줍니다."]
  },
  "Death": {
    past:    ["기존 흐름이 완전히 종결됐던 전환점이었습니다.","오래된 패턴이 끝나고 새 국면이 시작됐습니다.","강제적 전환이 있었지만 그것이 새 출발이 됐습니다.","과거의 종결이 현재 흐름의 토대를 만들었습니다."],
    present: ["지금은 기존 흐름이 종결되고 전환이 진행 중입니다.","익숙한 것을 내려놓아야 다음 흐름이 열립니다.","강제적 전환이 최선의 결과로 이어질 수 있는 구간입니다.","끝냄으로써 시작되는 에너지가 작동하고 있습니다."],
    future:  ["앞으로 기존 흐름의 종결과 새 시작이 동시에 옵니다.","전환을 받아들이는 것이 최선의 전략이 됩니다.","끝과 시작의 경계에서 결단이 필요합니다.","새로운 국면을 위해 기존 것을 내려놓는 시점이 옵니다."]
  },
  "Justice": {
    past:    ["균형과 공정한 결과가 흐름의 기반이 됐습니다.","객관적 판단이 출발점이 됐던 시기였습니다.","리스크와 수익의 균형이 작동했던 때였습니다.","공정한 평가가 방향을 결정했습니다."],
    present: ["지금은 객관적이고 균형 잡힌 판단이 요구됩니다.","감정이 아닌 데이터와 사실이 판단 기준이 되어야 합니다.","균형 잡힌 접근이 최선의 결과를 만들어냅니다.","공정한 시각으로 현재 흐름을 평가해야 합니다."],
    future:  ["앞으로 공정하고 균형 잡힌 결과가 도출됩니다.","객관적 판단이 보상받는 흐름이 형성됩니다.","균형이 회복되며 명확한 방향이 나타납니다.","리스크와 수익의 균형점이 찾아지는 시점이 옵니다."]
  },
  "Temperance": {
    past:    ["절제와 균형이 흐름의 안정을 만들었습니다.","과도한 욕심 없이 꾸준히 쌓아온 시기였습니다.","분산과 조율이 리스크를 낮췄던 흐름이었습니다.","인내와 절제가 기반이 됐던 때였습니다."],
    present: ["지금은 절제와 균형이 최선의 접근인 구간입니다.","과도한 비중보다 분산이 안정적 결과를 만듭니다.","서두르지 않는 인내가 흐름을 지탱하고 있습니다.","균형 잡힌 포트폴리오가 요구되는 시점입니다."],
    future:  ["앞으로 절제와 균형이 결과를 만들어냅니다.","꾸준한 인내가 보상받는 흐름이 형성됩니다.","과도함을 피하면 안정적 성과가 따릅니다.","균형이 유지될 때 최선의 결과가 옵니다."]
  },
  "Two of Swords": {
    past:    ["결정을 미루며 교착 상태가 지속됐던 시기였습니다.","정보 부족으로 명확한 판단이 어려웠습니다.","두 가지 선택지 사이에서 망설였던 때였습니다.","행동 없는 관망이 이어졌던 흐름이었습니다."],
    present: ["지금은 명확한 결정을 내리기 어려운 교착 구간입니다.","정보가 불완전한 상태에서 판단이 요구됩니다.","두 방향 사이에서 균형을 잡아야 하는 시점입니다.","성급한 결정보다 충분한 정보 수집이 먼저입니다."],
    future:  ["앞으로 교착이 풀리며 방향이 명확해집니다.","결정을 미뤄온 것들이 해결되는 시점이 옵니다.","정보가 충분해지면 자연스럽게 길이 열립니다.","교착 이후 더 명확한 흐름이 형성됩니다."]
  },
  "Six of Swords": {
    past:    ["불안정한 상황을 떠나 새 방향을 찾았던 시기였습니다.","기존 흐름에서 벗어나 전환을 시도했습니다.","고통스러운 이탈이었지만 더 나은 곳을 향했습니다.","전환의 시도가 현재 흐름의 토대가 됐습니다."],
    present: ["지금은 불안정한 흐름에서 벗어나는 전환이 진행 중입니다.","기존 전략을 내려놓고 새 방향을 탐색하는 시점입니다.","이동 중의 불안함이 있지만 방향은 맞습니다.","전환의 과정에서 인내가 필요한 구간입니다."],
    future:  ["앞으로 전환이 완료되며 더 안정된 흐름이 찾아옵니다.","불안정함을 지나면 새 출발의 에너지가 열립니다.","이탈 이후 더 나은 기회가 기다리고 있습니다.","전환의 결실이 드러나는 시점이 옵니다."]
  },
  "Knight of Pentacles": {
    past:    ["꾸준하고 신중한 접근이 흐름의 기반을 만들었습니다.","서두르지 않는 안정적 진행이 있었던 시기였습니다.","느리지만 확실한 방식이 출발점이 됐습니다.","책임감 있는 접근이 포지션을 형성했습니다."],
    present: ["지금은 신중하고 꾸준한 접근이 요구되는 구간입니다.","빠른 판단보다 체계적인 검토가 최선입니다.","안정성을 중시하는 흐름이 작동하고 있습니다.","책임감 있는 단계적 접근이 결과를 만듭니다."],
    future:  ["앞으로 꾸준함이 결실을 맺는 흐름이 형성됩니다.","신중한 접근이 안정적 성과로 이어집니다.","서두르지 않는 전략이 최선의 결과를 만들어냅니다.","단계적 실행이 목표에 도달하게 해줍니다."]
  },
  "Nine of Pentacles": {
    past:    ["독립적 성과와 자립의 에너지가 기반을 만들었습니다.","스스로의 노력으로 안정을 이룬 흐름이었습니다.","자기 완성의 에너지가 강했던 시기였습니다.","독립적 판단이 출발점이 됐던 때였습니다."],
    present: ["지금은 독립적이고 안정된 흐름이 형성되어 있습니다.","외부에 흔들리지 않는 자립 에너지가 작동합니다.","자신만의 기준을 지키는 것이 최선인 구간입니다.","성숙한 판단과 독립성이 흐름을 이끌고 있습니다."],
    future:  ["앞으로 독립적 안정감이 결실로 드러납니다.","자립의 에너지가 성과를 만들어냅니다.","스스로의 기준이 보상받는 흐름이 형성됩니다.","독립적 성취가 다음 단계를 열어줍니다."]
  }
};
...
function getCardSentence(card, isReversed, position, promptText) {
  ...
  // 해시 계산 (카드명 + 포지션 + 질문 앞 10자)
  const hashSrc = name + position + (promptText || '').slice(0, 10);
  let h = 0;
  for (let i = 0; i < hashSrc.length; i++) h = ((h << 5) - h + hashSrc.charCodeAt(i)) | 0;
  ...
  const t0 = tags[0];
  const t1 = tags[1] || t0;
  // 해시로 폴백 문장도 다양화 (동일 카드 반복 방지)
  const _fbTemplates = {
    past: [
      `과거에는 ${t0}의 에너지가 흐름의 기반을 형성했습니다.`,
      `${t0}의 흐름이 지나온 경로를 만들었습니다.`,
      `과거 흐름은 ${t0}의 국면을 지나왔습니다.`,
      `${t0}와 ${t1}의 에너지가 출발점이 됐습니다.`
    ],
    present: [
      `현재는 ${t0}의 에너지가 흐름을 주도하고 있습니다.`,
      `지금 흐름의 핵심에는 ${t0}가 있습니다.`,
      `${t0}의 에너지가 현재 상황을 규정하고 있습니다.`,
      `현재 ${t0}와 ${t1}의 흐름이 교차하고 있습니다.`
    ],
    future: [
      `앞으로는 ${t0}의 흐름이 방향을 결정하게 됩니다.`,
      `${t0}의 에너지가 다음 흐름을 만들어갑니다.`,
      `앞으로 ${t0}의 국면이 다가오고 있습니다.`,
      `${t0}를 통해 미래의 방향이 결정됩니다.`
    ]
  };
  const _fbArr = _fbTemplates[position] || _fbTemplates.present;
  return _fbArr[idx % _fbArr.length];
}

// ══════════════════════════════════════════════════════════════════
// [V203.12] CARD_RISK_POOL — 위험 카드 25장 포지션별 문장
//   현재카드용(now): 지금 조심 톤
//   미래카드용(coming): 다가오는 위험 톤
// ══════════════════════════════════════════════════════════════════
// [V203.13] CARD_RISK_POOL — stock/crypto 전용
//   연애 도메인에서 투자 문구 섞임 버그 원인
//   getCardRisk에서 domain='love'이면 CARD_RISK_POOL_LOVE 사용
const CARD_RISK_POOL_LOVE = {
  "The Tower":       { now:["갑작스러운 충격이 관계를 흔들 수 있습니다","예상치 못한 변화가 관계 기반을 위협합니다"], coming:["관계에 급격한 변화가 다가오고 있습니다","기반이 흔들리는 전환점에 대비해야 합니다"] },
  "The Moon":        { now:["오해와 착시가 관계를 흐리고 있습니다","표면 신호를 그대로 믿기 어려운 구간입니다"], coming:["불확실성이 고조되는 구간이 다가옵니다","숨겨진 감정이 드러나며 관계가 흔들릴 수 있습니다"] },
  "The Devil":       { now:["집착이 관계를 옥죄고 있습니다","감정적 의존이 건강한 흐름을 방해합니다"], coming:["집착에서 벗어나지 못하면 관계가 더 힘들어집니다","감정 의존의 패턴을 끊어야 하는 시점이 옵니다"] },
  "Seven of Swords": { now:["솔직하지 못한 소통이 관계를 흐리고 있습니다","숨겨진 감정이 신뢰를 약화시키고 있습니다"], coming:["숨겨진 진심이 드러나는 순간이 올 수 있습니다","불투명한 소통이 관계 위기로 이어질 수 있습니다"] },
  "Five of Swords":  { now:["자존심 충돌이 진짜 감정을 가리고 있습니다","이기려는 태도가 관계를 상처 입히고 있습니다"], coming:["자존심 싸움이 관계를 더 멀어지게 할 수 있습니다","상처를 봉합하지 않으면 거리감이 굳어집니다"] },
  "Three of Swords": { now:["감정적 상처가 현재 흐름에 영향을 미칩니다","아픔이 아직 치유되지 않은 상태입니다"], coming:["감정적 충격을 직면해야 하는 순간이 다가옵니다","상처를 외면하면 관계 회복이 더 어려워집니다"] },
  "Nine of Swords":  { now:["과도한 걱정이 판단을 흐리고 있습니다","두려움이 현실을 왜곡하고 있습니다"], coming:["불안이 극대화되는 순간이 다가올 수 있습니다","심리적 압박을 다스리지 않으면 관계가 더 힘들어집니다"] },
  "Eight of Swords": { now:["스스로 만든 제약이 행동을 막고 있습니다","두려움이 선택지를 좁히고 있습니다"], coming:["제약에서 벗어나야 하는 결단의 순간이 옵니다","선택지가 더 좁아지기 전에 행동해야 합니다"] },
  "The Hanged Man":  { now:["기다림이 길어지면 감정이 식을 수 있습니다","결정을 미루는 것이 관계 에너지를 소진시킵니다"], coming:["기다림의 끝에서 결단이 필요합니다","보류가 길어지면 관계 흐름이 굳어질 수 있습니다"] },
  "Four of Cups":    { now:["감정적 무관심이 관계 신호를 놓치게 합니다","권태가 중요한 감정 교류를 막고 있습니다"], coming:["무관심이 지속되면 상대가 멀어질 수 있습니다","감정적 단절이 현실이 되는 시점이 다가옵니다"] },
  "Seven of Cups":   { now:["환상이 현실적인 관계 판단을 방해합니다","비현실적 기대가 실망의 씨앗이 됩니다"], coming:["환상이 깨지는 순간이 다가오고 있습니다","현실과 기대의 차이를 직시해야 합니다"] },
  "Eight of Cups":   { now:["감정적 이탈 에너지가 관계에 작용합니다","더 나은 것을 찾으려는 충동이 관계를 흔듭니다"], coming:["이탈 충동이 행동으로 이어질 수 있습니다","관계를 떠나고 싶은 에너지가 강해질 수 있습니다"] },
  "Ten of Swords":   { now:["관계가 바닥을 경험하고 있는 구간입니다","추가적인 상처가 생길 수 있는 시점입니다"], coming:["최악의 상황에 대비가 필요합니다","관계 종결의 에너지가 다가오고 있습니다"] },
  "Five of Pentacles":{ now:["감정적 결핍과 외로움이 관계를 힘들게 합니다","지원 부족이 두 사람을 지치게 하고 있습니다"], coming:["어려운 국면이 관계를 시험하는 시기가 옵니다","감정적 지지가 필요한 순간이 다가옵니다"] },
  "The Hierophant":  { now:["형식과 기대가 진짜 감정을 억누르고 있습니다","틀에 맞추려는 압박이 관계를 경직시킵니다"], coming:["기존 방식 고수가 관계 발전을 막을 수 있습니다","유연함이 필요한 순간이 다가옵니다"] },
  "Six of Cups":     { now:["과거에 매달리는 것이 현재 관계를 흐립니다","향수가 현실적인 판단을 방해하고 있습니다"], coming:["과거 집착이 새로운 흐름을 막는 순간이 옵니다","현실을 직시해야 관계가 앞으로 나아갑니다"] },
  "Four of Pentacles":{ now:["지나친 자기 보호가 관계를 닫히게 합니다","감정을 내어주지 않으려는 방어가 거리를 만듭니다"], coming:["마음의 문을 열지 않으면 관계 진전이 어렵습니다","방어적 태도가 상대를 멀어지게 할 수 있습니다"] },
  "Ten of Wands":    { now:["관계에서 오는 부담이 한계에 달하고 있습니다","과도한 감정적 짐이 두 사람을 지치게 합니다"], coming:["부담이 한계를 넘으면 관계가 무너질 수 있습니다","감정적 짐을 내려놓지 않으면 소진됩니다"] },
  "Nine of Wands":   { now:["방어적 태도가 진정한 소통을 막고 있습니다","마지막 버티기 에너지가 관계를 긴장시킵니다"], coming:["더 이상 버티기 어려운 순간이 다가옵니다","방어를 내려놓는 용기가 필요한 시점이 옵니다"] },
  "The Lovers":      { now:["선택의 갈등이 관계를 흔들고 있습니다","가치관 차이가 표면으로 드러나고 있습니다"], coming:["중요한 선택의 순간이 다가오고 있습니다","결정을 미루면 관계 방향이 표류할 수 있습니다"] },
  "Five of Wands":   { now:["경쟁과 자존심이 관계 에너지를 소모합니다","밀고 당기기가 감정을 지치게 하고 있습니다"], coming:["갈등이 심화되는 구간이 다가올 수 있습니다","자존심 싸움을 내려놓아야 관계가 숨을 쉽니다"] }
};

const CARD_RISK_POOL = {
  "The Tower":       { now:["급격한 충격 에너지가 포지션을 위협합니다","예측 불가한 변동성이 현재 흐름에 내재합니다"], coming:["급격한 붕괴 신호에 미리 대비해야 합니다","예상치 못한 충격이 다가올 수 있습니다"] },
  "The Moon":        { now:["정보 모호함이 판단을 흐리고 있습니다","착시 가능성이 높은 구간입니다"], coming:["불확실성이 고조되는 구간이 다가옵니다","표면 신호를 맹신하면 손실로 이어질 수 있습니다"] },
  "The Devil":       { now:["감정적 집착이 냉정한 판단을 방해합니다","욕심이 리스크를 키우고 있습니다"], coming:["집착에서 벗어나지 못하면 손실이 확대됩니다","탐욕이 판단을 흐리는 구간이 옵니다"] },
  "Seven of Swords": { now:["정보 비대칭이 판단을 방해하고 있습니다","겉으로 드러나지 않는 변수가 존재합니다"], coming:["숨겨진 리스크가 현실화될 수 있습니다","정보 왜곡에 주의해야 하는 구간이 옵니다"] },
  "Five of Swords":  { now:["자존심 충돌이 합리적 판단을 막고 있습니다","갈등의 잔재가 흐름을 방해합니다"], coming:["충돌보다 화해가 더 나은 결과를 만듭니다","자존심을 내려놓아야 하는 순간이 옵니다"] },
  "Three of Swords": { now:["손실 충격 에너지가 현재 흐름에 작용합니다","감정적 타격이 판단을 흐릴 수 있습니다"], coming:["충격적인 손실 신호가 다가오고 있습니다","아픔을 직면할 준비가 필요합니다"] },
  "Nine of Swords":  { now:["심리적 불안이 실제 이상으로 흐름을 왜곡합니다","두려움이 냉철한 판단을 방해합니다"], coming:["과도한 걱정이 판단 미스로 이어질 수 있습니다","심리적 압박을 다스려야 하는 구간이 옵니다"] },
  "Eight of Swords": { now:["선택지가 제한된 구속 에너지가 작동합니다","탈출구가 보이지 않는 것처럼 느껴지는 구간입니다"], coming:["제약이 커지기 전에 행동 기준을 세워야 합니다","선택지가 좁아지는 흐름이 다가옵니다"] },
  "Five of Pentacles":{ now:["실질적 손실 에너지가 현재 흐름에 있습니다","비용 관리가 소홀해지면 위험이 커집니다"], coming:["어려운 국면이 다가오고 있습니다","손실 대비 전략이 미리 필요합니다"] },
  "The Hanged Man":  { now:["결정 미룸이 기회 비용을 키우고 있습니다","정체가 장기화되면 흐름에 뒤처질 수 있습니다"], coming:["결정을 미루면 기회를 놓칠 수 있습니다","보류가 장기화되는 흐름에 주의해야 합니다"] },
  "Four of Cups":    { now:["기회를 놓치는 권태 에너지가 작동합니다","관심 저하로 중요한 신호를 간과할 수 있습니다"], coming:["무관심이 기회 손실로 이어질 수 있습니다","권태가 판단 공백을 만드는 구간이 옵니다"] },
  "Seven of Cups":   { now:["비현실적 기대가 판단을 흐리고 있습니다","환상과 현실을 구분해야 하는 시점입니다"], coming:["과도한 낙관이 실망으로 이어질 수 있습니다","환상에 기반한 결정은 손실을 부릅니다"] },
  "Eight of Cups":   { now:["포기나 이탈 에너지가 흐름에 작용합니다","성급한 청산이 더 나은 기회를 놓칠 수 있습니다"], coming:["이탈 충동이 최적 타이밍을 앞당길 수 있습니다","감정적 포기보다 기준에 따른 결정이 필요합니다"] },
  "Ten of Swords":   { now:["바닥 에너지가 현재 흐름에 작용합니다","추가 손실 가능성이 있는 구간입니다"], coming:["최악의 구간이 다가올 수 있으니 대비가 필요합니다","손절 기준을 미리 세워야 합니다"] },
  "The Star (Rev)":  { now:["희망이 현실화되지 않는 구간입니다","지나친 낙관이 판단을 흐립니다"], coming:["회복이 지연되는 흐름에 주의해야 합니다","기대와 현실의 차이를 직시해야 합니다"] },
  "Six of Swords":   { now:["불안정한 전환이 진행 중인 구간입니다","이동 중의 불안이 판단을 흐릴 수 있습니다"], coming:["전환기의 불안정함이 리스크를 높입니다","안정이 회복되기 전 섣부른 결정을 피해야 합니다"] },
  "Two of Swords":   { now:["정보 부족 상태에서 교착이 지속됩니다","결정 회피가 기회 비용을 키우고 있습니다"], coming:["교착 상태가 길어지면 기회를 놓칩니다","정보가 불충분한 상태에서의 결정은 위험합니다"] },
  "Ten of Wands":    { now:["과부하 에너지가 집중력을 분산시킵니다","비중이 과도하게 높아진 구간입니다"], coming:["과열이 지속되면 탈진으로 이어집니다","비중 축소 타이밍을 놓치지 않아야 합니다"] },
  "Nine of Wands":   { now:["상승 피로 에너지가 흐름에 작용합니다","마지막 버티기 구간에서 경계가 필요합니다"], coming:["피로가 정점에 달하는 구간이 옵니다","무리한 보유가 손실로 전환될 수 있습니다"] },
  "Knight of Wands": { now:["무모한 돌진 에너지가 리스크를 키웁니다","충동적 진입이 단기 손실로 이어질 수 있습니다"], coming:["과속 진입이 역효과를 낼 수 있는 구간이 옵니다","속도보다 방향 확인이 먼저입니다"] },
  "The Lovers":      { now:["선택의 기로에서 결단이 지연되고 있습니다","가치관 충돌이 판단을 방해합니다"], coming:["중요한 선택의 순간이 다가오고 있습니다","결정을 미루면 기회 비용이 커집니다"] },
  "Five of Wands":   { now:["경쟁과 혼란이 방향성을 흐리고 있습니다","노이즈가 많아 핵심 신호를 구분하기 어렵습니다"], coming:["경쟁이 심화되는 구간이 다가옵니다","혼란 속에서 자신의 기준을 잃지 않아야 합니다"] },
  "The Hierophant":  { now:["변화 저항이 새로운 기회 포착을 방해합니다","보수적 접근이 유연성을 제한합니다"], coming:["기존 방식 고수가 리스크로 작용할 수 있습니다","유연한 대응이 필요한 구간이 옵니다"] },
  "Six of Cups":     { now:["과거 집착이 현재 판단을 방해합니다","향수가 현실적 선택을 막고 있습니다"], coming:["과거에 매달리면 현재 기회를 놓칩니다","현실 직시가 필요한 순간이 옵니다"] },
  "Four of Pentacles":{ now:["과도한 보수성이 기회를 막고 있습니다","변화 거부가 유연성을 제한합니다"], coming:["지나친 현금 보유가 기회 비용을 키웁니다","때로는 용기 있는 결정이 필요합니다"] }
};

// [V203.13] 카드 기반 RISK 추출 함수 — 도메인별 풀 분리
//   연애: CARD_RISK_POOL_LOVE (관계 언어)
//   투자: CARD_RISK_POOL (시장 언어)
//   이전 버그: 연애에 "비중이 과도", "현금 보유" 등 투자 문구 섞임
function getCardRisk(card, isReversed, isFuture, domain) {
  const name = typeof card === 'string' ? card : (card?.name || '');
  // 도메인별 풀 선택 — 연애는 LOVE 풀 우선
  const pool = (domain === 'love')
    ? (CARD_RISK_POOL_LOVE[name] || null)
    : (CARD_RISK_POOL[name] || null);
  const pos = isFuture ? 'coming' : 'now';

  if (pool && pool[pos] && pool[pos].length > 0) {
    // 랜덤보다 카드명 해시로 일관성 유지
    let h = 0;
...
// [V203.13] buildCriticalInterpretation — subType 파라미터 추가 (scalping/holding/short 분기)
function buildCriticalInterpretation(cards, revFlags, domain, intent, subType) {
  ...
  function _keyInsight(domain, intent, signal) {
    ...
    // [V203.13] 스타일별 핵심 결론 분기
    if (subType === 'short') {
      if (signal === 'BUY')  return '카드 흐름이 단기 진입 타이밍에 우호적입니다';
      if (signal === 'SELL') return '카드 흐름이 단기 추격 자제를 가리킵니다';
      return '카드 흐름이 돌파 신호 확인 후 진입을 가리킵니다';
    }
    if (subType === 'scalping') {
      if (signal === 'BUY')  return '카드 흐름이 스캘핑 진입 에너지를 가리킵니다';
      if (signal === 'SELL') return '카드 흐름이 스캘핑 보류와 방향 확인을 가리킵니다';
      return '카드 흐름이 거래량 신호 확인 후 진입을 가리킵니다';
    }
    if (subType === 'holding') {
      if (signal === 'BUY')  return '카드 흐름이 장기 DCA 분할 매수에 우호적입니다';
      if (signal === 'SELL') return '카드 흐름이 비중 축소와 리밸런싱을 가리킵니다';
...
function applyCryptoVocabulary(metrics, stockSubType, stockIntent) {
  ...
  const VOCAB = {
    crypto_buy: {
      ...
      coreKey: '🟢 단계적 분할 진입 + 리스크 한계 기준 설정 + 24시간 변동성 관리 핵심'
    },
    crypto_sell: {
      ...
      coreKey: '🔴 즉시 단계적 분할 청산 + 변동성 확대 시 잔여 정리 + 욕심 차단 핵심'
    },
    scalping: {
...
const TLDR_CORE_MATRIX = {
  // ★★★ [V202.20 사장님 95점 포맷] ★★★
  //   주식·코인 6개 시나리오 — 색상 신호 + 보편 표현 (수치 0)
  //   ★ [V202.28] V202.20 95점 포맷 수치 ★ 완전 제거 ★
  //   사장님 진단: 30~50% / 5일 / 0% / +30% 등 구체 수치 = 자본시장법 위반 가능
  //   해결: 모든 수치 → 보편 표현 ('단계적' / '신호 확인 후' / '분할 접근' 등)
  //   안전: 색상 신호 + 행동 어휘 + 보편 부사 (자본시장법·SEC 100% 안전)
  wait_buy:  '🟡 방향 형성 중 — 신호 확인 후 분할 접근 유효 (확인 없는 일괄 진입은 손실 노출)',
  wait_sell: '🔴 익절 흐름 형성 — 단계적 청산 유효 (청산 지연 시 수익 반납 가능)',
  verified:  '🟢 진입 조건 충족 — 분할 접근 적기 (풀 진입은 변동성 직접 노출)',
  limited:   '🟡 제한 시도 구간 — 소액 테스트 유효 (본격 진입은 변동성 노출 가능)',
  active:    '🟢 진입 흐름 형성 — 단계적 매수 유효 (변동성 관리 기준 설정 필수)',
  split:     '🟢 분할 진입 적기 — 단계별 접근 유효 (계획 없는 분할은 평균단가 흔들림)',
...
const ASSET_TAIL_MATRIX = {
  // ★★★ [V202.28 사장님 D-2 명령] 95점 포맷 수치 ★ 완전 제거 ★
  //   V202.20 옛 표현: '30~50%' '5일' 등 — ★ 자본시장법 위반 가능 ★
  //   사장님 진단: 라이브 사용자 노출 → 법적 리스크 직격
  //   해결: 모든 수치 → 보편 표현 ('단계적' / '신호 확인 후' / '분할 접근')
  //   BUY 톤 (진입 위험 경고) — 🟢/🟡 색상 + 행동
  stock_buy:       '⚡ 행동: 신호 확인 → 단계적 분할 진입 → 추세 동조 시 보강',
  crypto_buy:      '⚡ 행동: 리스크 한계 기준 → 단계적 분할 → 단계별 보강',
  // SELL 톤 (청산 지연 위험 경고) — 🔴 색상 + 행동
  stock_sell:      '⚡ 행동: 단계적 분할 청산 → 추세 둔화 시 잔여 정리',
  crypto_sell:     '⚡ 행동: 즉시 단계적 분할 정리 → 변동성 확대 시 잔여 청산'
};
...
// ══════════════════════════════════════════════════════════════════
// ══════════════════════════════════════════════════════════════════
// [V202.20 사장님 95점 포맷] 5가지 개선 통합:
//   ① 시각 위계 — "5초 결정" (한 줄 결론 → 근거 → 리스크)
//   ② 어휘 매트릭스 3등급 — 같은 의미 ★ 다른 표현 ★ (반복 차단)
//   ③ 카드 → 행동 직결 — 추상 표현 X (구체 행동 명시)
...
const TOP_VERDICT_MATRIX = {
  ...
  // ─── 단타 (SHORT-TERM) ───
  short_breakout: {
    signal:  '🔥 돌파 진입 — 거래량 확인 필수',
    action:  '시가 돌파 확인 후 즉시 진입, 손절 3~5% 고정',
    caution: '거래량 미동반 돌파는 추격 금지',
    energy:  '★★★★★'
  },
  short_pullback: {
    signal:  '🟢 눌림목 대기 — 진입 조건 접근',
    action:  '지지선 확인 후 소량 선진입, 이탈 시 즉시 손절',
    caution: '추가 하락 가능성 — 분할 진입 필수',
    energy:  '★★★★☆'
  },
  short_wait: {
    signal:  '🟡 돌파 확인 필요 — 관망 우선',
    action:  '저항선 돌파 신호 대기, 거래량 증가 확인 후 진입',
    caution: '조급한 진입 시 단기 손실 확대 가능',
    energy:  '★★★☆☆'
  },
  short_avoid: {
    signal:  '🔴 단기 과열 — 추격 금지',
    action:  '고점 매수 자제, 눌림 후 재진입 기회 대기',
    caution: '현재 가격대 진입 시 단기 손실 가능성 높음',
    energy:  '★★☆☆☆'
  },

  // ─── 코인 스캘핑 (SCALPING) ───
  scalping_entry: {
    signal:  '⚡ 스캘핑 진입 — 거래량·변동성 확인',
    action:  '분·시간 단위 진입, 손절 1~2% 타이트 설정',
    caution: '거래량 미동반 시 즉시 포지션 축소',
    energy:  '★★★★★'
  },
  scalping_wait: {
    signal:  '🟡 스캘핑 대기 — 변동성 확대 신호 탐색',
    action:  '거래량 급증 구간까지 진입 보류',
    caution: '조급한 진입 시 슬리피지 손실 확대',
    energy:  '★★★☆☆'
  },
  scalping_avoid: {
    signal:  '🔴 스캘핑 보류 — 방향성 불명확',
    action:  '명확한 방향 신호 확인 후 재진입 검토',
    caution: '횡보 구간 스캘핑은 수수료 손실 누적',
    energy:  '★★☆☆☆'
  },

  // ─── 코인 홀딩 (HOLDING) ───
  holding_accumulate: {
    signal:  '🟢 분할 매수 적기 — DCA 진입 유효',
    action:  '주·월 단위 분할 매수, 리밸런싱 기준 설정',
    caution: '일괄 진입 시 단기 변동성 노출 확대',
    energy:  '★★★★☆'
  },
  holding_hold: {
    signal:  '🟡 홀딩 유지 — 추가 매수 보류',
    action:  '현 포지션 유지, 리밸런싱 기준 재점검',
    caution: '단기 변동성에 흔들려 매도 시 장기 기회 상실',
    energy:  '★★★☆☆'
  },
  holding_reduce: {
    signal:  '🟠 비중 축소 검토 — 단계적 정리',
    action:  '장기 목표가 도달 시 분할 익절 실행',
    caution: '전량 청산보다 단계적 비중 축소가 유리',
    energy:  '★★★☆☆'
  }
};
...
function buildTopVerdict(metrics) {
  ...
  // [V203.13] 스타일별 시나리오 키 선택 — short/scalping/holding
  const _ts = metrics.totalScore || 0;
  const _sub = metrics.stockSubType || '';

  if (_sub === 'short') {
    // 주식 단타 — 총점 기반 4시나리오
    if (_ts >= 4)       key = 'short_breakout';
    else if (_ts >= 1)  key = 'short_pullback';
    else if (_ts >= -2) key = 'short_wait';
    else                key = 'short_avoid';

  } else if (_sub === 'scalping') {
    // 코인 스캘핑 — 총점 기반 3시나리오
    if (_ts >= 3)       key = 'scalping_entry';
    else if (_ts >= -1) key = 'scalping_wait';
    else                key = 'scalping_avoid';

  } else if (_sub === 'holding') {
    // 코인 홀딩 — 총점 기반 3시나리오
    if (_ts >= 3)       key = 'holding_accumulate';
...
const STOCK_BLOCK_MATRIX = {
  ...
  wait_buy: {
    ...
    TURN: ['핵심:', '주의:', '실행 기준:'],
    RISK: [
      // ★ [V202.28] 구체 수치 → 보편 표현 (어휘 5등급 다양화)
      '확인 전 진입 시 손실 노출 가능 (분할 접근 권장)',
      '검증 미충족 매수는 손익 분기점 (관망 우선)',
      '신호 부족 구간 — 진입 시 변동성 노출 가능',
      '확인 없는 진입 = 손실 전환 가능성 높음',
      '신호 정렬 전 진입 = 최대 리스크 구간'
    ],
    RHYTHM: ['short', 'mid', 'long']
  },
  
  // 🟢 verified: 신호 확정 — 분할 진입 권장
  verified: {
    CORE: [
      '🟢 진입 조건 충족 — 분할 매수 권장',
      '🟢 신호 명확화 — 단계적 진입 적기',
    ...
    RISK: [
      '풀 진입 X — 분할 접근이 안전',
      '조건 미충족 진입 시 버티기 구간 전환',
      '단계 없는 일괄 진입 = 변동성 직접 노출',
      '검증 마무리 단계 — 단계적 분할 권장',
      '일괄 진입 시 손익 분기점 — 분할 진입 우선'
    ],
    RHYTHM: ['short', 'mid', 'long']
  },
  
  // 🟡 limited: 제한 시도 — 소액 테스트만
  limited: {
    CORE: [
      '🟡 제한적 시도 구간 — 소액 테스트만',
      '🟡 진입 여지 일부 존재 — 신중 접근',
    ...
    TURN: ['핵심:', '제한 기준:', '주의:'],
    RISK: [
      '본격 진입 X — 추가 하락 가능성 동반',
      '소액 테스트 외 = 리스크 우위 구간',
      '확인 없는 진입 = 손실 노출 가능성',
      '제한 없는 시도 = 변동성 확대 노출',
      '본격 진입 시 손익 분기점 — 소액 한정'
    ],
    RHYTHM: ['short', 'mid', 'long']
  },
  
  // 🟢 active: 진입 활성 — 분할 매수 적기
  active: {
    CORE: [
      '🟢 진입 타이밍 활성 — 분할 매수 권장',
      '🟢 실행 구간 명확 — 단계적 1차 진입',
    ...
    RISK: [
      '변동성 노출 — 리스크 한계 기준 설정',
      '시점 선택이 결과 좌우 — 단계적 진입',
      '진입보다 관리가 성과 결정 — 추격 매수 금지',
      '단기 변동성 휘둘림 시 수익 구조 흔들림',
      '관리 없는 진입 = 손익 분기점 — 기준 필수'
    ],
    RHYTHM: ['short', 'mid', 'long']
  },
  
  // 🟢 split: 분할 진입 — 단계별 기준 설정
  split: {
    CORE: [
      '🟢 분할 진입 적기 — 단계별 접근',
      '🟢 단계적 접근 유효 — 기준 명확화 필수',
    ...
    TURN: ['핵심:', '단계 기준:', '주의:'],
    RISK: [
      '무계획 분할 = 평균단가 흔들림 — 기준 필수',
      '각 단계 기준 설정 = 수익 구조 결정',
      '단계별 점검 없으면 비중만 늘어남',
      '계획 없는 분할 = 손익 분기점 ↑',
      '단계 기준 없으면 분할 효과 X — 계획 우선'
    ],
    RHYTHM: ['short', 'mid', 'long']
  },
  ...
  wait_sell: {
    ...
    TURN: ['핵심:', '청산 기준:', '주의:'],
    RISK: [
      '청산 타이밍 = 수익 결정 (분할 정리 권장)',
      '청산 지연 = 수익 반납·손실 전환 위험',
      '분할 청산 안전 — 추가 유지보다 정리 우선',
      '"얼마 더 먹느냐"보다 "얼마 지키느냐"가 결과',
      '욕심 = 수익 구조 무너짐 — 분할 정리 적기'
    ],
    RHYTHM: ['short', 'mid', 'long']
  }
};
...
const V31_LUNAR_DATA = {
  ...
  // ★★★ [V202.18 사장님 명령] 1900-1989 데이터 추가 ★★★
  //   사장님 라이브 결함:
  //     사주 1975년 입력 시 음력 표시 안 됨
  //   원인: V31_LUNAR_DATA에 1990년부터만 데이터 → 1975 = undefined → null 반환
  //   해결: 한국천문연구원 표준 데이터 1900-1989 ★ 90년 추가 ★
  //   효과: 1900-2030 ★ 131년 ★ 음력 변환 가능
  1900: [8, 29, [29,30,29,30,29,30,29,30,30,29,30,30]],  // 윤8월
  1901: [0,  0, [29,30,29,29,30,29,30,29,30,30,30,30]],
  1902: [0,  0, [29,30,29,29,30,29,30,29,30,30,30,30]],
  1903: [5, 29, [29,29,30,29,30,29,29,30,29,30,30,30]],  // 윤5월
  1904: [0,  0, [30,29,30,29,30,29,29,30,29,30,29,30]],
  1905: [0,  0, [30,30,29,30,29,30,29,29,30,29,30,29]],
  1906: [4, 30, [30,30,29,30,30,29,30,29,30,29,30,29]],  // 윤4월
  1907: [0,  0, [30,29,30,30,29,30,30,29,29,30,29,30]],
  1908: [0,  0, [29,30,29,30,29,30,30,29,30,29,30,29]],
  1909: [2, 29, [30,29,30,29,30,29,30,29,30,30,29,30]],  // 윤2월
  1910: [0,  0, [29,30,29,30,29,29,30,30,29,30,30,29]],
  1911: [6, 30, [30,29,30,29,29,30,29,30,29,30,30,30]],  // 윤6월
  1912: [0,  0, [29,30,29,30,29,29,30,29,30,29,30,30]],
  1913: [0,  0, [30,29,30,29,30,29,29,30,29,30,29,30]],
  1914: [5, 30, [30,30,29,30,29,30,29,29,30,29,30,29]],  // 윤5월
  1915: [0,  0, [30,30,29,30,29,30,29,30,29,30,29,29]],
  1916: [0,  0, [30,30,29,30,29,30,29,30,30,29,30,29]],
  1917: [2, 29, [29,30,29,30,29,30,29,30,30,29,30,30]],  // 윤2월
  1918: [0,  0, [29,29,30,29,30,29,29,30,30,29,30,30]],
  1919: [7, 30, [30,29,29,30,29,30,29,29,30,30,29,30]],  // 윤7월
  1920: [0,  0, [30,29,30,29,30,29,29,30,29,30,29,30]],
  1921: [0,  0, [30,30,29,30,29,30,29,29,30,29,30,29]],
  1922: [5, 29, [30,30,29,30,30,29,30,29,30,29,30,29]],  // 윤5월
  1923: [0,  0, [30,29,30,30,29,30,29,30,29,30,29,30]],
  1924: [0,  0, [29,30,29,30,29,30,30,29,30,29,30,29]],
  1925: [4, 29, [30,29,30,29,30,29,30,29,30,30,29,30]],  // 윤4월
  1926: [0,  0, [29,30,29,29,30,29,30,29,30,30,29,30]],
  1927: [0,  0, [30,29,30,29,29,30,29,30,29,30,30,30]],
  1928: [2, 29, [29,30,29,30,29,29,30,29,30,30,30,29]],  // 윤2월
  1929: [0,  0, [30,29,30,29,30,29,29,30,29,30,30,29]],
  1930: [6, 30, [30,30,29,30,29,30,29,29,30,29,30,29]],  // 윤6월
  1931: [0,  0, [30,30,29,30,29,30,29,30,29,30,29,30]],
  1932: [0,  0, [29,30,30,29,30,29,30,29,30,29,30,29]],
  1933: [5, 30, [30,29,30,29,30,29,30,30,29,30,29,30]],  // 윤5월
  1934: [0,  0, [29,30,29,30,29,30,29,30,30,29,30,30]],
  1935: [0,  0, [29,29,30,29,30,29,29,30,30,29,30,30]],
  1936: [3, 29, [30,29,29,30,29,30,29,30,29,30,30,30]],  // 윤3월
  1937: [0,  0, [29,30,29,29,30,29,30,29,30,29,30,30]],
  1938: [7, 30, [30,29,30,29,29,30,29,30,29,30,29,30]],  // 윤7월
  1939: [0,  0, [30,30,29,30,29,29,30,29,30,29,30,29]],
  1940: [0,  0, [30,30,29,30,30,29,30,29,30,29,29,30]],
  1941: [6, 29, [29,30,30,29,30,30,29,30,29,30,29,30]],  // 윤6월
  1942: [0,  0, [29,30,29,30,30,29,30,29,30,29,30,29]],
  1943: [0,  0, [30,29,30,29,30,29,30,30,29,30,29,30]],
  1944: [4, 29, [29,30,29,30,29,30,29,30,29,30,30,29]],  // 윤4월
  1945: [0,  0, [30,29,30,29,30,29,29,30,29,30,30,29]],
  1946: [0,  0, [30,30,29,30,29,29,30,29,30,29,30,30]],
  1947: [2, 30, [29,30,30,29,30,29,29,30,29,30,29,30]],  // 윤2월
  1948: [0,  0, [30,29,30,30,29,29,30,29,30,29,30,29]],
  1949: [7, 30, [30,30,29,30,29,30,29,30,29,30,29,30]],  // 윤7월
  1950: [0,  0, [29,30,29,30,29,30,29,30,30,29,30,29]],
  1951: [0,  0, [30,29,30,29,30,29,30,29,30,30,29,30]],
  1952: [5, 29, [29,30,29,30,29,29,30,29,30,30,30,29]],  // 윤5월
  1953: [0,  0, [30,29,30,29,29,30,29,29,30,30,29,30]],
  1954: [0,  0, [30,30,29,30,29,30,29,29,30,29,30,30]],
  1955: [3, 29, [29,30,30,29,30,29,30,29,29,30,29,30]],  // 윤3월
  1956: [0,  0, [30,29,30,30,29,30,29,30,29,30,29,30]],
  1957: [8, 29, [29,30,29,30,29,30,29,30,30,29,30,29]],  // 윤8월
  1958: [0,  0, [30,29,29,30,29,30,30,30,29,30,29,30]],
  1959: [0,  0, [29,30,29,29,30,29,30,29,30,30,30,29]],
  1960: [6, 30, [30,29,30,29,30,29,29,30,29,30,30,30]],  // 윤6월
  1961: [0,  0, [29,30,29,30,29,29,30,29,30,29,30,30]],
  1962: [0,  0, [30,29,30,29,30,29,29,30,29,30,29,30]],
  1963: [4, 29, [30,30,29,30,29,30,29,29,30,29,30,29]],  // 윤4월
  1964: [0,  0, [30,30,29,30,30,29,30,29,29,30,29,30]],
  1965: [0,  0, [29,30,30,29,30,29,30,29,30,29,30,29]],
  1966: [3, 29, [30,29,30,29,30,30,29,30,29,30,29,30]],  // 윤3월
  1967: [0,  0, [29,30,29,30,29,30,29,30,30,29,30,29]],
  1968: [7, 30, [30,29,30,29,30,29,29,30,30,29,30,30]],  // 윤7월
  1969: [0,  0, [29,30,29,29,30,29,29,30,30,29,30,30]],
  1970: [0,  0, [30,29,30,29,29,30,29,30,29,30,30,30]],
  1971: [5, 29, [29,30,29,30,29,29,30,29,30,29,30,30]],  // 윤5월
  1972: [0,  0, [30,29,30,30,29,29,30,29,30,29,30,29]],
  1973: [0,  0, [30,30,29,30,29,30,29,30,29,30,29,30]],
  1974: [4, 29, [29,30,30,29,30,29,30,29,30,29,30,30]],  // 윤4월
  1975: [0,  0, [29,30,29,30,29,30,29,30,29,30,30,30]],
  1976: [8, 30, [29,30,29,30,29,30,29,30,29,30,30,29]],  // 윤8월
  1977: [0,  0, [30,29,30,29,30,29,29,30,29,30,29,30]],
  1978: [0,  0, [30,29,30,29,30,29,30,29,30,29,30,29]],
  1979: [6, 30, [30,30,29,30,30,29,30,29,30,29,30,29]],  // 윤6월
  1980: [0,  0, [29,30,30,29,30,30,29,30,29,30,29,30]],
  1981: [0,  0, [29,30,29,30,29,30,30,29,30,29,30,29]],
  1982: [4, 29, [30,29,30,29,30,29,30,29,30,30,29,30]],  // 윤4월
  1983: [0,  0, [29,30,29,29,30,29,30,29,30,30,29,30]],
  1984: [10, 29, [30,29,30,29,29,30,29,30,29,30,30,30]],  // 윤10월
  1985: [0,  0, [29,30,29,30,29,29,30,29,30,29,30,30]],
  1986: [0,  0, [30,29,30,29,30,29,29,30,29,30,29,30]],
  1987: [6, 29, [30,30,29,30,29,30,29,29,30,29,30,29]],  // 윤6월
  1988: [0,  0, [30,30,29,30,30,29,30,29,29,30,29,30]],
  1989: [0,  0, [30,30,29,30,29,30,29,30,29,30,29,29]],
...
function v31SolarToLunar(solarYear, solarMonth, solarDay) {
  // 음력설 양력 날짜 (1900-2030) — V202.18 1900-1989 추가
  const LUNAR_NEW_YEAR = {
    // ★ V202.18 1900-1989 추가 (사장님 1975 결함 잡음) ★
...
// ════════════════════════════════════════════════════════════════════
// ★★★ [V202.54.0 Step 4.5] V54_SIPSUNG_EXPLAIN — 십성 일상 언어 풀이 ★★★
//   사장님 통찰: 20-30대 유저는 "겁재/편인/편재/식신" 용어 모름
//   해결: 10 십성을 "나와 같은 성분 · 경쟁자" 같은 일상 언어로 풀이
//   사장님 7원칙 ③: 사주 용어 → 일상 언어 (마지막 빈 영역 완성)
// ════════════════════════════════════════════════════════════════════

const V54_SIPSUNG_EXPLAIN = {
  '비견': {
    short:  '🤝 함께 밀고 가는 힘',
    action: '독립·동행·자기 추진',
    detail: '내 페이스를 지키며 동료와 나란히 가는 힘이에요. 자기 색이 뚜렷한 게 강점이지만, 혼자 끌어안다 보면 나누고 맡기는 게 어려워질 수 있어요.'
  },
  '겁재': {
    short:  '⚔ 부딪치며 커지는 힘',
    action: '경쟁·승부·관계 충돌',
    detail: '경쟁 속에서 진가가 나오는 승부형이에요. 추진력·돌파력이 강하지만, 돈의 들고남과 사람과의 마찰이 함께 따라올 수 있어요.'
  },
  '식신': {
    short:  '🌿 삶을 풀어내는 힘',
    action: '표현·생산·여유',
    detail: '내 안의 것을 자연스럽게 풀어내는 힘이에요. 여유와 표현이 살아나지만, 너무 풀어지면 집중이 흩어질 수 있어요.'
  },
  '상관': {
    short:  '🔥 틀을 깨는 힘',
    action: '창의·반항·직설',
    detail: '기존 방식을 바꾸고 새 길을 만드는 힘이에요. 창의력이 폭발하지만, 규칙이나 관계와는 부딪치기 쉬워요.'
  },
  '편재': {
    short:  '💰 크게 움직이는 돈의 흐름',
    action: '사업·기회·확장',
    detail: '큰 흐름의 돈과 기회를 다루는 힘이에요. 사업·영업 감각이 뛰어나지만, 그만큼 변동도 크고 분산되기 쉬워요.'
  },
  '정재': {
    short:  '🪙 안정적으로 쌓는 돈복',
    action: '현실·관리·생활력',
    detail: '꾸준히 모으고 지키는 현실 감각이에요. 신용과 저축이 강점이지만, 큰 도전 앞에선 망설일 수 있어요.'
  },
  '편관': {
    short:  '⚡ 압박을 돌파하는 힘',
    action: '긴장·승부·강한 책임',
    detail: '압박과 위기 속에서 단련되는 힘이에요. 결단력·추진력이 강하지만, 무리하면 다툼·소진으로 이어질 수 있어요.'
  },
  '정관': {
    short:  '🏛 사회 안에서 인정받는 힘',
    action: '조직·신뢰·명예',
    detail: '규범과 책임 안에서 인정받는 힘이에요. 조직·명예가 따라오지만, 갑작스러운 변화엔 적응이 더딜 수 있어요.'
  },
  '편인': {
    short:  '🌙 혼자 깊어지는 사고',
    action: '직감·몰입·예민함',
    detail: '혼자 파고들며 깊어지는 직관의 힘이에요. 통찰·몰입이 살아나지만, 자칫 바깥과 단절되기 쉬워요.'
  },
  '정인': {
    short:  '☀ 보호받으며 성장하는 힘',
    action: '배움·안정·회복',
    detail: '배움과 인덕으로 받쳐지는 안정의 힘이에요. 학습·회복이 강점이지만, 누군가에게 기대는 마음이 커질 수 있어요.'
  }
};
        ...
        const bars = distEntries
          ...
          .map(([sipsung, score]) => {
            ...
            return {
              ...
              // ★ V202.54.0 Step 4.5 ★ 십성 일상 언어 풀이 (20-30대 친화)
              //   사장님 7원칙 ③: "겁재" → "나와 같은 성분 · 경쟁자"
              explain: V54_SIPSUNG_EXPLAIN[sipsung] || null
            };
          });
...
function buildStockMetrics({ totalScore, riskScore, cleanCards, isLeverage, queryType, prompt, intent, reversedFlags, stockSubType }) {
  ...
  let criticalRules;
  // ★ [V203.10 E안] criticalRules 체크리스트형으로 전환
  //   문장형("~합니다") → 명사구 체크리스트 (ACTION = 어떻게, 실행 순서)
  if (stockIntent === "sell") {
    if (totalScore <= -3) {
      criticalRules = [
        "1. 현재 손익 기준 재확인",
  ...
  if (riskGate.triggered && stockIntent === 'sell') {
    ...
    // ★ [V203.10 E안] riskGate 발동 시 체크리스트형
  ...
  if (_blockDecision) {
    ...
    return {
      ...
      layers: {
        ...
        rules: criticalRules,
        criticalInterpretation: buildCriticalInterpretation(cleanCards, _revFlags, _domain, stockIntent, stockSubType)
      }
    };
  }
  ...
  let criticalInterpretation = buildCriticalInterpretation(cleanCards, _revFlags, _domain, stockIntent, stockSubType);
  ...
  if (_gateTriggered && stockIntent === 'buy') {
    _uncOverride = {
      ...
      entryTriggers: [
        // ★ [V202.28] 구체 수치(5일선/+30%/15%) ★ 완전 제거 ★ — 사장님 라이브 결함 진단
        //   옛 표현: "일봉 5일선 회복 + 거래량 평균 대비 +30% 동시 충족 시 시범 진입 (15%)"
        //   = 자본시장법·기술적 분석 추천 ★ 위반 가능 ★
        //   해결: 보편 표현 ('추세 회복 신호' / '거래량 동반' / '단계적')
        { stage: '0차',       action: '현재 진입 보류 — 신호 확인 우선이 안정적인 흐름입니다' },
        { stage: '1차 신호',  action: '추세 회복 신호 + 거래량 동반 확인 시 시범 진입 검토' },
        { stage: '2차 확정',  action: '추세 안정화 확인 후 단계적 추가 진입 검토' },
...
function buildLoveCoreInsight(content, flowArrow, metaPattern, cards, revFlags, loveSubType) {
  ...
  // [V202.49.0 매니페스토 #8] Phrase Diversity Engine — line3/line4 시작 어휘 다양화
  ...
  // [V202.50.1 C] "관계의 감정적 무게는" → "관계의 감정 흐름은"
  //   사장님 라이브 검증 결함: "감정적 무게 ... 균형 쪽으로 기울어져" — 무게 vs 균형 모순
  //   해결: "무게" 어휘를 "흐름"으로 변경 → 5종 시작 어휘 + 서술어 결합 자연도 100%
  const _line4Starters = [
    '이미 감정의 중심축은',  // 기존
    '두 분의 감정 흐름은',
    '관계의 감정 흐름은',
    '지금 감정의 결은',
...
function buildLoveRisk(content, loveSubType, cards, prompt, reversedFlags) {
  ...
  // [V203.12] CARD_RISK_POOL 기반 RISK — 카드별 고유 위험 문구
  //   현재카드: "지금 조심" 톤 / 미래카드: "다가오는 위험" 톤
  let _cardRisk1 = content.risk_1;
  let _cardRisk2 = content.risk_2;
  if (cards && cards.length >= 3) {
    try {
      const _r1 = getCardRisk(cards[1], (reversedFlags||[])[1], false, 'love');
      const _r2 = getCardRisk(cards[2], (reversedFlags||[])[2], true,  'love');
      if (_r1) _cardRisk1 = _r1;
      // 중복 방지
      if (_r2 && _r2 !== _r1) _cardRisk2 = _r2;
    } catch(e) { /* 안전: 기존값 유지 */ }
  }
...
//
// ★★★ [V202.52.1 사장님 라이브 결함] 4단어 누락 보강 ★★★
//   라이브 분석: '단계 9회 / 정리 11회 / 회복 9회 / 종결' — 분산 시스템 밖
//   원인: V26.0 풀 설계 시 LOVE_FLOW_KEY_POOL.breakup 등의 핵심 어휘 미포함
//   효과: 이별/재회/결혼 서브타입 본문 어휘 단조로움 즉시 해소
// ══════════════════════════════════════════════════════════════════
const LOVE_SYNONYM_MAP = {
  ...
  '정체':   ['정체', '멈춤', '지연', '제자리'],
  '흐름':   ['흐름', '기류', '진행', '추세'],
  // ★ V202.52.1 추가 ★ 라이브 반복 빈도 9~11회 단어
  '단계':   ['단계', '시기', '지점', '구간'],
  '정리':   ['정리', '마무리', '정돈', '매듭'],
  '회복':   ['회복', '복구', '재정비', '치유'],
  '종결':   ['종결', '마침', '끝맺음', '결말']
...
// ══════════════════════════════════════════════════════════════════
// ★★★ [V202.52.2 사장님 결정적 결함] 시제 자동 교정 시스템 ★★★
//   사장님 라이브 결함:
//     PAST · Five of Wands → "지금은 많은 노력을..."      ← ❌ 현재 시제
//     PRESENT · Nine of Wands → "미래에는 감정적 소통..." ← ❌ 미래 시제
//     (시제가 한 칸씩 밀린 채 출력)
//
//   기존: V26.3 결함 1 매니페스토로 LLM에 지시 → 그러나 카드 의미에 끌려 무시됨
//   해결: 워커 후처리 자동 교정 ★ 코드 레벨 강제 ★
//
//   원리:
//     1. LLM 출력 텍스트에서 "과거 / 현재 / 미래" 라벨 블록 분리
//     2. 각 블록 첫 문장 시작 어구 검사
//     3. 라벨과 시제 어긋남 발견 시 → 라벨에 맞는 시작 어구로 자동 치환
//     4. 정상 케이스(시제 일치)는 무변환 (안전)
//
    ...
    if (request.method === "POST") {
      try {
        ...
        if (queryType === "stock" || queryType === "crypto") {
          ...
          // ════════════════════════════════════════════════════════════════
          // ★★★ [V202.52.5 사장님 결정적 결함] 한글 이름 환각 차단 ★★★
          //   V202.52.4 라이브 케이스 3 결함:
          //     사장님 입력 "이소영 최민식 결혼운"
          //     실제 출력 "이th영님과 최민식님의 관계는~" ← '소' 가 'th'로 깨짐
          //   원인: LLM이 prompt 안에서 직접 이름 추출 시 한글 토큰화 환각 발생
          //         (LLM 입장에서 "이소영" → "이th영" 같은 음소 혼동)
          //   해결: 워커가 입력에서 ★ 정규식으로 명시 추출 ★ 후 LLM에게 변수로 전달
          //         → LLM은 추출된 이름 그대로 사용 (환각 차단)
          //
          //   추출 우선순위:
          //     1. '이름1 + 와/과/랑/하고 + 이름2' (조사 결합)
          //     2. '이름1 · 이름2' 또는 '이름1, 이름2' (구분자)
          //     3. '이름1 이름2' (공백 구분, 가장 흔함)
          //     4. '나와/저랑 + 이름' (자기 생략 + 1명)
          //     5. '이름 + 님' (호칭형 단일)
          //     6. '이름 + 와의/랑의' (관계형 단일)
          ...
          //
          //   ★★★ [V202.52.4 사장님 라이브 결함] 자연어 의도 우선 분류 ★★★
          //   결함: "결혼운은?" + 이름 2개 입력 → 명시 버튼 없음 + hasTargetPerson=true
          //         → compatibility 자동 추정 → 결혼 입력에 궁합 답 반환 ★ 결제 직격 ★
          ...
          if (!finalLoveSubType && !_v43_isExplicitLoveIntent && hasTargetPerson(prompt)) {
            ...
            // 이별 키워드
            else if (/이별|헤어|이혼|결별|관계\s*끝|끝낼|끝내야|정리하/.test(prompt)) {
              finalLoveSubType = 'breakup';
            }
            // 재회 키워드
            else if (/재회|다시\s*만|돌아오|돌아올|다시\s*시작|복원/.test(prompt)) {
              finalLoveSubType = 'reunion';
            }
            // 키워드 없으면 기존 안전망 그대로 (compatibility 추정)
            else {
        ...
        if (isFinanceQuery) {
          ...
          //   ★ [V202.28 사장님 D-3] 95점 포맷 + 수치 금지 강제 ★
          const legalSafetyGuide = `
[법무 안전 표현 — ★ 사장님 D-3 강화 ★ — 매우 중요, 모든 문장에 반드시 적용]
한국 자본시장법 + 미국 SEC + 공인중개사법 영역 회피를 위해 다음 규칙을 ★ 엄격히 ★ 준수하라:

★★★ [V202.28] 절대 금지 — 구체 수치 0% ★★★
다음 표현은 ★ 어떤 경우에도 출력 금지 ★ (자본시장법·SEC 직접 위반):
   ❌ "30%", "30~50%", "10~20%", "1차 30%", "분할 30~50% 매수"
   ❌ "5일", "3거래일", "1~3일", "1주일", "20일선", "5일선"
   ❌ "손절 -5~-7%", "-7~-10% 기준", "+30% 충족"
   ❌ "거래량 +30% 동시 충족", "양봉 우위 N거래일"
   ❌ "권장 비중: 0%", "권장 비중: N%"
   ❌ 모든 % 기호 + 모든 N일/N거래일 표기
...
★ 대체 표현 (반드시 이것만 사용) ★:
   ...
   ✅ "추세 동조 시" (3거래일 대신)
   ✅ "리스크 한계 기준" (-5~-7% 대신)
   ✅ "추세 안정화 확인 후" (양봉 N거래일 대신)
   ✅ "관망이 안정적인 흐름" (권장 비중: 0% 대신)
   ✅ "분할 접근 유효" / "단계별 매수 검토" (구체 비중 대신)
...
3. 표현 변환 예시 (V202.28 추가):
   "5일선 회복 + 거래량 +30% 충족 시 시범 진입 (15%)"
     → "추세 회복 신호와 거래량 동반 확인 시 시범 진입이 고려될 수 있습니다"
   "1차 30% 분할 진입 후 추세 동조 시 보강"
     → "신호 확인 후 단계적 1차 분할 진입 → 추세 동조 시 단계별 보강"
   "권장 비중: 0%"
     → "관망이 안정적인 흐름으로 해석됩니다"
   "손절 -5~-7% 설정"
     → "리스크 한계 기준 설정이 도움이 될 수 있습니다"

4. 본문 톤: 명령/지시 0%, 가능성/해석 100%

5. ★ V202.28 95점 포맷 정신 ★:
   • 🟢/🟡/🔴 색상 신호로 직관 전달 (수치 의존 X)
   • 어휘 다양화 — 같은 의미 ★ 다른 표현 ★ (반복 금지)
   • "분할" "단계적" "신호 확인" 같은 보편 부사 적극 사용`;
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[V203.20 서사 방향 잠금 — 본문 작성 전 최종 확인]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
위 [★ 최우선 방향 선언]에 명시된 방향이 이 점사의 유일한 결론 방향이다.
ZEUS ORACLE 본문(서사)을 작성할 때:
  ① 서사의 마지막 문단이 위 방향과 일치해야 한다
  ② 서사 중 "두 사람의 결은 맞물려" 같은 표현이 방향=close/realign일 때 절대 금지
  ③ 서사 중 "발전 가능", "결속으로 향하는" 표현이 방향=close일 때 절대 금지
  ④ 서사 중 "정리", "거리두기", "내면 회복" 표현이 방향=advance일 때 결론으로 금지
  ⑤ 이 규칙을 어기면 사용자가 결론과 서사의 충돌을 느낀다 — 앱의 신뢰가 무너진다
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[V203.10 핵심 흐름 해석 (Core Insight) — 카드 이름 직접 인용 의무화]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
★ CORE INSIGHT의 유일한 역할:
  "왜 이 카드 3장이 이 방향을 만들었는가"
  — 카드 이름을 직접 인용한 인과만. 일반론 절대 금지.
...
✅ 4줄 구조 (반드시 이 순서):
  1줄: [과거 카드명]이/가 ~했기 때문에 지금 흐름이 ~로 시작됐습니다.
  2줄: [현재 카드명]이/가 ~ 때문에 흐름이 ~합니다.
  3줄: [미래 카드명]이/가 ~을 가리키기 때문에 방향은 ~입니다.
  4줄: "👉 핵심: [카드 3장이 만들어낸 결론 한 줄 — VERDICT 방향과 반드시 일치]"

🚨 절대 금지:
  - 카드 이름 없이 "현재 흐름은 ~" 형식 — 일반론 (카드와 무관한 문장)
  - 같은 의미 문장 반복 (예: "단계적 진입이 유효" → "단계적 접근이 효과적" 반복 금지)
  - "카드는 ~을 의미합니다", "카드는 ~을 나타냅니다" — 단순 의미 해석
  - 행동 지침, 타이밍, 리스크 언급
  - 4줄 초과 또는 3줄 미만
  - "👉 핵심: " 마무리 누락
  - 👉 핵심 결론이 VERDICT 방향과 충돌하는 문장

✅ VERDICT↔WHY 방향 일치 규칙 (필수):
  - VERDICT가 🟢(매수/진입/진전)이면 → WHY 결론도 긍정 방향
    예: "👉 핵심: 카드 3장이 분할 진입에 우호적인 흐름을 가리킵니다"
  - VERDICT가 🟡(관망/탐색)이면 → WHY 결론도 확인 우선
    예: "👉 핵심: 카드 3장이 확인 후 신중한 접근을 가리킵니다"
  - VERDICT가 🔴(매도/정리)이면 → WHY 결론도 정리 방향
    예: "👉 핵심: 카드 3장이 모두 정리 구간 진입을 가리킵니다"

✅ 좋은 예시 (투자 매수 — verified):
"Queen of Cups가 직관적 진입 에너지를 쌓았기 때문에 현재 흐름이 긍정적으로 시작됐습니다.
King of Cups가 감정 통제와 관망을 가리키기 때문에 지금은 확인 후 단계적 접근이 유효합니다.
Five of Wands 역방향이 내부 조율 과정을 가리키기 때문에 급격한 변동성은 제한적입니다.
👉 핵심: \"카드 흐름이 분할 진입에 우호적인 방향을 가리킵니다\""

✅ 좋은 예시 (연애 close — 정리):
"The Tower가 관계의 기반 붕괴를 가리켰기 때문에 현재 흐름이 재정립 단계로 시작됐습니다.
Five of Cups가 상실 에너지를 강화하고 있어 감정 회복이 지연되고 있습니다.
Eight of Swords가 내면 구속을 가리키기 때문에 지금 방향은 자기 해방이 우선입니다.
👉 핵심: \"카드 3장이 모두 관계 정리와 내면 회복 방향을 가리킵니다\""

✅ 좋은 예시 (연애 advance — 진전):
"Seven of Pentacles가 인내의 기반을 쌓았기 때문에 현재 흐름이 자연스럽게 이어집니다.
The Empress가 풍요와 확장 에너지를 강화하고 있어 감정 교류가 열려 있습니다.
Two of Wands가 새로운 비전을 가리키기 때문에 지금 흐름은 진전 가능 방향입니다.
👉 핵심: \"카드 3장이 자연스러운 발전 구간을 가리킵니다\""


[V203.13 투자 스타일별 전용 규칙 — stockSubType 기반]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
${stockSubType === 'short' ? `
📌 주식 단타(short-term) 전용 해석 규칙:
  - 모든 카드 해석을 단기(당일~3일) 관점으로 작성
  - "장기 보유", "중장기", "안정적 가치" 표현 금지
  - 대신: "단기 모멘텀", "거래량", "당일 흐름", "돌파/눌림", "변동성" 사용
  - ZEUS ORACLE: 언제 진입? 어떤 신호? 손절 기준? 3문장으로
  - 카드 해석 예시:
    Ten of Pentacles → "수급 안정적, 단타보다 스윙 적합한 흐름"
    The Star → "단기 반등 모멘텀 형성 가능성"
    Four of Swords → "에너지 응축 — 돌파 신호 대기"
` : ''}
${stockSubType === 'scalping' ? `
📌 코인 스캘핑(scalping) 전용 해석 규칙:
  - 모든 카드 해석을 분·시간 단위 초단기 관점으로 작성
  - "장기 보유", "중장기", "가치 투자" 표현 완전 금지
  - 대신: "순간 모멘텀", "거래량 급증", "분봉 돌파", "슬리피지", "타이트 손절" 사용
  - ZEUS ORACLE: 지금 진입 가능한가? 거래량 신호는? 손절 라인은? 3문장
  - 카드 해석 예시:
    Eight of Wands → "빠른 모멘텀 — 스캘핑 진입 적기 신호"
    The Moon → "방향 불명확 — 스캘핑 보류, 횡보 가능성"
    Ace of Swords → "결단의 순간 — 돌파 확인 즉시 진입"
` : ''}
${stockSubType === 'holding' ? `
📌 코인 홀딩(holding) 전용 해석 규칙:
  - 모든 카드 해석을 주·월 단위 장기 관점으로 작성
  - "단기 차익", "단타", "빠른 진입" 표현 금지
  - 대신: "DCA(분할 매수)", "리밸런싱", "장기 가치", "펀더멘털", "사이클" 사용
  - ZEUS ORACLE: 지금 DCA 진입 적기인가? 홀딩 유지 근거는? 장기 방향은? 3문장
  - 카드 해석 예시:
    Seven of Pentacles → "인내의 DCA — 꾸준한 분할 매수 적합"
    The Tower → "급락 리스크 — 비중 축소 후 재진입 검토"
    The Star → "장기 회복 흐름 — 홀딩 유지 근거"
` : ''}

[V203.9 연애 점사 전용 규칙 — 일반 규칙보다 우선]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
질문이 연애/관계 도메인인 경우 아래 규칙을 반드시 적용하라.

📌 카드 해석(과거/현재/미래) — 연애 전용:
  - 각 카드 단락에 반드시 "상대는 ~하고 있고" 또는 "상대의 ~은 ~한 상태" 포함
  - 질문자 내면만 묘사하는 단락 금지 — 두 사람의 행동/반응을 모두 담을 것
  - 예시(좋음): "상대는 아직 확신을 정리하는 중이며, 질문자의 흐름은 기다림에서 행동으로 전환 중입니다."
  - 예시(나쁨): "두 분의 결이 자연스럽게 맞물리고 있습니다." (추상적, 상대 행동 없음)
...
📌 ONE LINE(한 줄 신탁) — 연애 전용:
  ...
  - 기억되는 문장: 읽고 나서 머릿속에 남는 한 줄
  - 동사로 끝내지 말 것 — 이미지나 상태로 마무리
  - 예시(좋음): "서두르지 않아도, 흐름은 이미 앞으로 움직이고 있습니다."
  - 예시(나쁨): "지금은 관계를 자연스럽게 키워가는 단계" (요약형)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
🚨🚨🚨 [V202.49.0 매니페스토 #3] 카드 본문 — 절대 길이 규칙 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ 절대 규칙: 각 카드(과거/현재/미래) 본문은 ★ 2~4문장 ★ 이내
  - 최소 2문장: 카드의 의미 + 관계와의 연결
  - 최대 4문장: 추가 설명이 필요한 경우에만 (기본은 3문장)
  - 한 문장은 50~80자 사이 (긴 문장 1개 < 짧은 문장 2개)
  - 5문장 이상 ★ 절대 금지 ★ (가독성 즉시 붕괴)

❌ 절대 금지 (사용자 이탈 직결):
  - 5문장 이상 본문 (스크롤 피로)
  - 한 문장 100자 초과 (모바일에서 줄바꿈 3회 이상)
  - "이는~", "또한~", "더불어~" 등 접속어 남발로 문장 연장
  - 같은 의미를 다른 표현으로 반복 (예: "긍정적이며 안정적입니다. 안정적인 분위기를 형성합니다.")

✅ 올바른 길이 예시 (3문장 모범):
  "과거의 흐름은 즐거움과 사회적 유대감을 가져왔습니다. 서로의 존재를 기뻐하며 긍정적인 에너지를 나누는 시기였습니다. 이는 관계의 시작 단계에서 강한 끌림을 느끼게 한 기반이 되었습니다."

⚠️ 위반 시 결과:
  - 사용자가 본문 중간 이탈 → 결제 전환률 즉시 하락
  - 매트릭스 시스템(블록 매트릭스)의 핵심 가치인 '간결한 결정성' 무력화

🚨🚨🚨 [V202.52.1 매니페스토 #4] 카드 본문 톤 — 사장님 톤 정렬 절대 규칙 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
사장님 라이브 결함 발견: 카드 본문이 "카드 사전 키워드" raw 나열로 떨어져 일반적·추상적
원인: LLM이 카드명 → 키워드 → 본문 직선 변환 (희망/치유/평온 등 키워드 그대로 노출)
효과: 사용자 인지 "어디서나 볼 수 있는 일반 해석" → 결제 가치 즉시 붕괴
해결: 3요소 강제 + 모범 톤 정렬

❌ 절대 금지 — 카드 사전 키워드 raw 나열:
  - "희망과 치유의 에너지가 가득합니다"          ← ❌ The Star 키워드 그대로
  - "성찰과 평가가 필요한 시점입니다"            ← ❌ Judgement 키워드 그대로
  - "새로운 시작과 안정적인 기회가 열릴 것입니다" ← ❌ Ace of Pentacles 키워드 그대로
  - "영감을 주며 평온함을 찾으려"                ← ❌ 카드 이미지 사전 정의 직접 노출

✅ 필수 3요소 (모든 서브타입 공통):
  1️⃣ 부정 전제로 시작 가능 ("~ 라기보다", "~ 였다기보다", "완전히 ~보다는")
     → 사용자가 자기 관계를 인식하는 방식과 일치 → 공감 즉시 형성
  2️⃣ 미묘한 결 묘사 (감정 소진, 상처 회피, 거리 조절, 흔적, 결, 여운 등)
     → 일반 톤에 없는 심리 디테일 → "여기서만 볼 수 있는 톤"
  3️⃣ 서브타입 맥락 반영 (이별/재회/썸/연락/짝사랑/결혼 각각 다른 정서 강도)
     → 사용자 질문 의도가 본문에 직접 반영 → 신뢰 가치 ↑

✅ 모범 톤 — 이별(breakup) 서브타입 (사장님 안):
  과거(The Star):
    "이미 한 차례 감정 소진을 지나온 뒤, 관계를 다시 믿어보려 했던 결에 
     가깝습니다. 완전히 뜨겁게 몰아붙이는 관계라기보다, 상처를 덜 건드리는 
     방식으로 서로를 바라보려 했던 흔적이 강합니다."
  
  현재(Judgement):
    "감정을 이어갈지 끝낼지를 현실적으로 판단하려는 시점입니다. 예전처럼 
     감정만으로 움직이기보다, '이 관계가 실제로 지속 가능한가'를 냉정하게 
     보기 시작한 지점에 가깝습니다."
  
  미래(Ace of Pentacles):
    "감정 자체보다 현실 회복과 안정 재구축에 가까운 카드입니다. 관계를 
     완전히 끊든 이어가든, 결국 자신의 삶을 다시 안정시키려는 방향으로 
     움직입니다."

✅ 카테고리별 정서 밀도 — 톤 강도 차별화 (절대 동일 톤 X):
  - 썸(thumb):       가볍고 미묘 ("아직 윤곽이 분명치 않은", "조심스럽게 살피는")
  - 연락(contact):   긴장/기다림 ("반응을 가늠하는", "신호를 기다리는")
  - 짝사랑(crush):   투사/혼자만의 해석 ("혼자 의미를 키우는", "마음만 앞서가는")
  - 재회(reunion):   후회/현실 ("완전히 놓지 못한", "다시 마주하려는")
  - 결혼(marriage):  구조/안정 ("삶의 결을 맞추는", "장기 합의를 검증하는")
  - 이별(breakup):   감정 정리 ("이미 지친 상태에 가까운", "거리 조절이 우선")

  ⚠️ 썸 서브타입에 "감정 소진 이후" 톤 출력 시 즉시 부자연 → 절대 금지

❌ 절대 금지 패턴 (V202.52.1 라이브 결함):
  - 카드 사전 정의 키워드 직접 노출 ("희망/치유/성찰/안정" 등 raw)
  - 모든 서브타입에 동일 정서 강도 적용 (썸 = 이별 톤은 즉시 부자연)
  - "긍정적이며 안정적입니다" 같은 일반적·추상적 결론
  - 카드 의미를 사용자 질문과 분리해 단독 해석

⚠️ 위반 시 결과:
  - 사용자 인지: "ChatGPT에서 본 적 있는 톤" → 결제 직전 이탈
  - V25.22 "사전 정의 풀 / 환각 0" 가치 무력화 (단조로움이 환각보다 더 큰 결함)
  - 사장님 차별화 가치 (V202.48 카드 텍스트 2-4문장 → V202.52.1 톤 깊이) 완성도 ↓

${_v52_5_extractedNames.length === 2 ? `
🚨🚨🚨 [V202.52.5 매니페스토 #6] 추출된 사용자 입력 이름 — 환각 절대 차단 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
사장님 V202.52.4 라이브 결함: "이소영 최민식" 입력 → "이th영님과 최민식님" 출력
원인: LLM이 한글 토큰화 시 환각 (음소 혼동)
해결: 워커가 정규식으로 ★ 명시 추출 ★ 후 LLM에 변수로 전달

✅ 이번 점사 추출된 두 사람 이름:
   • 이름1: "${_v52_5_extractedNames[0]}"
   • 이름2: "${_v52_5_extractedNames[1]}"

🚨 절대 규칙 (환각 0건 강제):
   1. ZEUS LOVE ORACLE 본문 호명 시 반드시 위 두 이름을 ★ 한 글자도 변경 없이 ★ 그대로 사용
   2. 형식: "${_v52_5_extractedNames[0]}님과 ${_v52_5_extractedNames[1]}님의 관계는~" (정확히 이대로)
   3. 다른 변형/축약/한자 변환/영문 변환 ★ 모두 절대 금지 ★
   4. 위 이름이 어색하게 보여도 ★ 사용자 입력 그대로 ★ 사용 (LLM 판단 금지)

❌ 절대 금지 패턴:
   • 음소 환각 ("이소영" → "이th영", "이쇼영", "이소엉" 등) ★ 결제 신뢰 즉시 붕괴 ★
   • 영문 음차 ("민식" → "minsik", "Min-sik" 등)
   • 축약 ("이소영" → "이영", "소영" 등)
   • 한자 변환 ("민식" → "敏植" 등)
...
` : _v52_5_extractedNames.length === 1 ? `
🚨🚨🚨 [V202.52.5 매니페스토 #6] 추출된 사용자 입력 이름 — 환각 절대 차단 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ 이번 점사 추출된 상대 이름:
   • 이름: "${_v52_5_extractedNames[0]}"

🚨 절대 규칙 (환각 0건 강제):
   1. ZEUS LOVE ORACLE 본문 호명 시 위 이름을 ★ 한 글자도 변경 없이 ★ 그대로 사용
   2. 형식: "${_v52_5_extractedNames[0]}님과의 관계는~" 또는 "${_v52_5_extractedNames[0]}님에 대한 흐름은~"
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
사장님 V202.52.1 라이브 결함 추가 발견:
  ① 결혼 케이스: 시제가 한 칸씩 밀림 (PAST + "지금은~" / PRESENT + "미래에는~") — 워커 후처리로 자동 교정 (V202.52.2 Track A)
  ② 썸 케이스: The Devil + Ten of Cups 역방향 → "굴레/속박/실망감" 출력 (썸인데!) — 무거운 카드 가이드 필요
  ③ 재회 케이스: "과거 관계는 순수하고 강력한 감정의 시작이었습니다" — 일반적 톤, 사장님 모범 톤 미적용
  ④ 궁합 케이스에서만 "하히라님과 최수종님" 호명 — 다른 서브타입(결혼/재회 등)도 호명 필요

✅ 카테고리별 모범 톤 — 5개 신규 추가 (V202.52.1의 이별 1개 + V202.52.2의 5개 = 총 6개):

[썸(thumb) 모범 톤 — 가볍고 미묘]
  과거(임의 카드):
    "서로를 살피는 거리에 머물러 있었던 시기에 가깝습니다. 
     마음의 윤곽이 분명하지 않았던 결로, 직접 표현보다 신호를 통해 
     서로를 가늠하던 흐름이 강합니다."
  현재(The Devil 같은 무거운 카드여도):
    "강한 끌림이 형성되어 있지만, 아직 서로의 페이스를 가늠하는 단계에 
     가깝습니다. 깊이 들어가기보다 조심스럽게 거리를 좁히는 결이며, 
     관계의 윤곽이 잡혀가는 중입니다."
  미래(임의 카드):
    "다가오는 흐름은 단계적인 접점 형성에 가깝습니다. 한 번에 정의되는 
     관계라기보다, 작은 신호들이 쌓이며 자연스럽게 윤곽이 잡혀가는 결로 
     이어집니다."

[연락(contact) 모범 톤 — 긴장/기다림]
  현재(임의 카드):
    "지금은 연락의 빈도와 톤을 가늠하는 시점에 가깝습니다. 답을 재촉하기보다 
     상대의 페이스를 살피며 신호를 조율하는 결로, 한 번의 메시지보다 흐름의 
     자연스러움이 결과를 좌우합니다."

[짝사랑(crush) 모범 톤 — 투사/혼자만의 해석]
  과거(임의 카드):
    "혼자 의미를 키워온 흐름에 가깝습니다. 상대의 작은 신호 하나하나에 
     큰 비중을 두며 마음을 키워왔던 결이며, 객관적인 거리감보다 내면의 
     해석이 앞서온 시기입니다."

[재회(reunion) 모범 톤 — 후회/현실 (★ 사장님 안 톤 정렬 ★)]
  과거(Ace of Cups 등):
    "한때 깊은 감정의 시작이 있었던 시기에 가깝습니다. 다만 그때의 순수함이 
     완전히 무르익기 전에 결의 어긋남이 생겼고, 지금 돌아보면 그 시기를 
     다시 만들 수는 없는 결이었습니다."
  현재(Eight of Swords 등):
    "지금은 스스로 만든 제약 안에 머물러 있는 결입니다. 완전히 놓지 못한 
     채 거리감만 깊어졌고, 해결책이 없다고 느끼는 시점에 가깝습니다."
  미래(Five of Swords 등):
    "앞으로는 자존심을 조금씩 내려놓는 흐름으로 향합니다. 완전히 화해라기보다, 
     관계를 다시 정의할 여지가 열리는 결에 가깝습니다."

[결혼(marriage) 모범 톤 — 구조/안정]
  현재(임의 카드):
    "지금은 감정만이 아니라 삶의 결을 맞추는 시점에 가깝습니다. 두 사람의 
     장기 합의를 검증하는 흐름이며, 가치관과 일상의 결합이 결과를 좌우하는 
     결입니다."

[궁합(compatibility) 모범 톤 — 본질 정렬]
  현재(임의 카드):
    "두 분의 결이 어느 지점에서 만나고 어느 지점에서 어긋나는지가 검증되는 
     시점에 가깝습니다. 표면의 조화가 아니라, 본질의 정합이 결과를 가르는 
     흐름입니다."

✅ 입력 이름 호명 — 사장님 신규 요청:
  사장님 안: 궁합("하히라/최수종") 케이스만 "하히라님과 최수종님의 관계는~" 호명 정상
            결혼/재회 등 다른 케이스에도 이름이 추출됐으면 동일하게 호명 필요

  ✅ 호명 규칙:
    1. 입력에서 이름 2개 추출 (궁합/결혼/재회) → 본문 시작 또는 ZEUS LOVE ORACLE 본문 시작에 
       "[이름1]님과 [이름2]님의 관계는~" 형태로 자연 호명 (실제 추출된 이름 그대로 치환)
    2. 입력에서 이름 1개 추출 (이별/짝사랑/연락 등 상대 1명만 언급) → ZEUS LOVE ORACLE 본문에 
       "[이름]님과의 관계는~" 또는 "[이름]님에 대한 흐름은~" 호명 (실제 추출된 이름 그대로 치환)
    3. 이름 미추출 → 호명 강제 X, 자연 톤 유지
  
  ❌ 절대 금지:
    - 호명을 카드 본문(과거/현재/미래)에 반복 (이름이 카드마다 등장하면 어색)
    - "유저님" 표현 사용 (V25.22 절대 금지)
    - 호명 위치는 ZEUS LOVE ORACLE 본문 ★ 1곳에서 1회만 ★ (카드 본문 호명 금지)

  ★★★ [V202.52.4 사장님 라이브 결함 #4 — 호명 위치 강화] ★★★
  V202.52.3 라이브 케이스 2 결함: PAST 카드 본문에 "이지영님과 최금니님" 호명 +
                                  ZEUS LOVE ORACLE에도 "이지영님과 최금니님" → 2회 호명
  원인: LLM이 "본문 시작에 호명" 규칙은 따랐지만 "1회만" 규칙은 안 따름
  강화 규칙:
    ✅ 호명은 ★ ZEUS LOVE ORACLE 본문 첫 줄 ★ 에서만 1회 (카드 본문은 절대 금지)
    ✅ 카드 본문(과거/현재/미래)에는 ★ 이름 등장 자체 금지 ★ — 카드 의미와 흐름만 서술
    ❌ "과거에는 [이름1]님과 [이름2]님 관계에..." 같은 카드 본문 호명 ★ 절대 금지 ★

  ★★★ [V202.52.4 사장님 라이브 결함 #3 — 이별 어휘 금지] ★★★
  V202.52.3 라이브 케이스 3 결함: 이별 본문에 "조심스러운 발전" 어휘 출현
  강화 규칙 (이별 서브타입 한정 절대 금지 어휘):
    ❌ "발전", "진전된 관계", "관계 확장", "결합 단계" (이별인데 발전? → 즉시 어색)
    ❌ "장기 결합", "관계 확정" (이별 종결 톤과 모순)
    ✅ 대체 어휘: "회복 진전", "정리 진행", "단계적 회복", "거리 안정화", "감정 안정"

✅ 무거운 카드 가이드 — 서브타입별 톤 우선 원칙:

  무거운 카드 = The Tower, The Devil, Death, Ten of Swords, Nine of Swords, Five of Pentacles, 
              Three of Swords, Five of Cups 등 부정/속박/상실 카드

  ✅ 무거운 카드가 가벼운 서브타입(썸/연락/짝사랑/궁합)에 나오면:
    - "굴레/속박/벗어나기 힘든" 같은 무거운 어휘 ★ 절대 금지 ★
    - 대신 "강한 끌림이 형성되어 있지만", "마음의 윤곽이 분명하지 않은", 
      "조심스럽게 거리를 좁히는" 등 ★ 서브타입 톤 ★ 우선
    - 카드의 부정 의미는 "단계적 접근 필요", "페이스 조율 필요" 등 ★ 행동 가이드 ★ 로 전환

  ✅ 무거운 카드가 무거운 서브타입(이별/재회)에 나오면:
    - 사장님 모범 톤("이미 ~를 지나온 뒤", "완전히 ~ 라기보다") 적용
    - 카드 본래 의미 충실히 반영 (긍정 가장 X)

  ❌ 절대 금지:
    - 썸 + The Devil → "자유롭기 어려운 묘한 굴레" ← V202.52.1 라이브 결함
    - 짝사랑 + Tower → "재앙적 붕괴" ← 짝사랑 톤 침범

⚠️ 위반 시 결과:
  - 사용자: "썸인데 왜 이별 톤?" 즉시 신뢰 붕괴
  - 서브타입 정서 밀도 매니페스토 (V202.52.1) 무력화
  - 결제 전환률 직격탄 (라이브 검증 4케이스 중 1건 발생)

🚨🚨🚨 [V202.50.1 결함 B] 카드 정역방향 의미 — 본문 일치 절대 규칙 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
사장님 라이브 결함 발견: Ten of Cups 정방향(완전한 결속·가족 행복)인데 본문은 "기대 충족 못함, 불균형" 부정 해석
원인: line1은 "완전한 결속" 정확 인식인데 본문은 역방향 해석으로 카드 의미 ↔ 본문 모순
해결 절대 규칙:

✅ 카드 정역방향 확인 절차:
  1. 입력 데이터의 카드 정역방향 정보 ★ 반드시 확인 ★
  2. 카드명 옆 "역방향" 표기 ★ 없으면 정방향 ★ — 카드 본래 정의 그대로 사용
  3. 정방향 긍정 카드 → 본문도 ★ 긍정 해석 ★ (절대 부정 해석 금지)
  4. 역방향 카드 → 지연·반전·내면화 해석 (긍정 정점 카드도 역방향이면 결핍/지연으로)

✅ 정방향 절대 부정 해석 금지 (점사 신뢰성 직결):
  - Ten of Cups 정방향 = 완전한 행복·가족 결속·감정 충만 → 본문도 ★ 긍정 ★
  - The Sun 정방향 = 성공·기쁨·명료함 → 본문도 ★ 긍정 ★
  - Three of Cups 정방향 = 축하·우정·기쁨 → 본문도 ★ 긍정 ★
  - The Lovers 정방향 = 결합·선택·조화 → 본문도 ★ 긍정 ★
  - Six of Wands 정방향 = 승리·인정·성취 → 본문도 ★ 긍정 ★
  - Ace of Cups 정방향 = 새 감정의 시작·사랑 → 본문도 ★ 긍정 ★
  - Nine of Cups 정방향 = 만족·소원 성취 → 본문도 ★ 긍정 ★
  - Two of Cups 정방향 = 결합·상호 끌림 → 본문도 ★ 긍정 ★
  - The Star 정방향 = 희망·치유·평온 → 본문도 ★ 긍정 ★
  - The World 정방향 = 완성·통합·성취 → 본문도 ★ 긍정 ★

❌ 절대 금지 패턴 (사용자 즉시 이탈):
  - "Ten of Cups 정방향" + 본문 "기대 충족 못함, 불균형"  ← ❌ 카드 의미 정반대 해석
  - "The Sun 정방향" + 본문 "어둠과 막힘"  ← ❌
  - line1의 카드 phrase ≠ 본문의 해석 방향
  - 정방향 긍정 카드를 부정·지연·결핍으로 풀이

✅ line1과 본문 일치 검증 (필수):
  - line1 = 카드 phrase (예: Ten of Cups 정방향 → "완전한 결속")
  - 본문 = ★ 같은 방향성 ★ 해석 (긍정 카드 → 긍정 본문, 역방향 카드 → 지연/반전 본문)
  - 모순 발생 시 본문 폐기 후 재작성

⚠️ 위반 시 결과:
  - 사용자: "카드 의미는 좋은데 본문은 왜 부정?" → 점사 시스템 자체 신뢰 즉시 붕괴
  - 결제 전환률 ★ 다른 결함보다 더 큰 하락 ★ (단조로움 < 모순 < 카드 의미 오역)
  - V25.22 "사전 정의 풀 / LLM 환각 0" 정신 무력화
...
${(queryType === 'love' || queryType === 'stock' || queryType === 'crypto' || queryType === 'life') ? `
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[V203.10 E안 — 블록별 역할 강제 분리]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
각 섹션은 정해진 질문에만 답한다. 다른 섹션의 역할을 침범 금지.

[핵심 흐름 해석 = WHY] 왜 지금 이 방향인가 — 카드 인과만. 결론·행동·타이밍 금지.
[TOP VERDICT = WHAT] 결론 한 줄만. 설명·이유·행동 금지.
[TIMING = WHEN] 언제 행동하는가만. 이유·결론 반복 금지.
[RISK = WHAT TO AVOID] 무엇을 조심하는가만. 최대 3항목. 결론 반복 금지.
[ACTION = HOW] 실행 순서만. 번호 목록. 문장형 설명 절대 금지.

이 역할 분리를 어기면 사용자 경험이 무너진다.
` : ''}
...
✅ 적절한 표현 (서브타입별 선택):
   - 일반/궁합/썸/연락/짝사랑/결혼: "자연스러운 진전", "신뢰 형성", "단계적 접근"
   - 이별(breakup): "회복 진전", "정리 진행", "단계적 회복" ★ '발전' 단어 절대 금지 ★
   - 재회(reunion): "재정렬 진전", "신중한 재접근", "단계적 회복"
