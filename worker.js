...
const V54_SIPSUNG_EXPLAIN = {
  ...
  '비견': {
    short:  '나와 같은 성분 · 동행',
    action: '자기 페이스를 유지하며 동료와 함께 가는 힘',
    detail: '비견이 강하면 자기 색이 분명해지지만, 협력 분배가 어려워지기 쉬운 성분입니다.'
  },
  '겁재': {
    short:  '나와 같은 성분 · 경쟁자',
    action: '자기 자리를 지키며 앞서가려는 추진 성분',
    detail: '겁재가 강하면 도전과 추진력이 강해지지만, 재물 변동과 갈등이 함께 따라오는 성분입니다.'
  },
  // ─── 식상(食傷) — 내가 풀어내는 성분 ───
  '식신': {
    short:  '내가 풀어내는 성분 · 표현·여유',
    action: '자기 안의 것을 자연스럽게 풀어내는 자질',
    detail: '식신이 강하면 여유와 표현이 살아나지만, 과하면 집중력이 흩어지기 쉬운 성분입니다.'
  },
  '상관': {
    short:  '내가 풀어내는 성분 · 창의·혁신',
    action: '기존 틀을 바꾸고 새 방식을 만드는 성분',
    detail: '상관이 강하면 창의력이 폭발하지만, 규범·관계와 충돌이 잦아지는 성분입니다.'
  },
  // ─── 재성(財星) — 내가 다스리는 성분 ───
  '편재': {
    short:  '내가 다스리는 성분 · 큰 재물·기회',
    action: '활동을 통해 큰 흐름의 돈을 다루는 성분',
    detail: '편재가 강하면 사업·영업 자질이 강하지만, 변동성과 분산도 함께 큰 성분입니다.'
  },
  '정재': {
    short:  '내가 다스리는 성분 · 안정 재물',
    action: '꾸준히 쌓아가는 정직한 재물 성분',
    detail: '정재가 강하면 신용과 저축이 강점이지만, 큰 도전이 부족해질 수 있는 성분입니다.'
  },
  // ─── 관성(官星) — 나를 누르는 성분 ───
  '편관': {
    short:  '나를 누르는 성분 · 강한 압박',
    action: '외부 압박과 위기 속에서 단련되는 성분',
    detail: '편관이 강하면 결단력과 추진력이 강해지지만, 무리·다툼·소진 위험이 함께 큰 성분입니다.'
  },
  '정관': {
    short:  '나를 누르는 성분 · 규범·책임',
    action: '규범과 책임이 따라오는 안정 성분',
    detail: '정관이 강하면 조직·명예가 따라오지만, 변화 대응이 늦어질 수 있는 성분입니다.'
  },
  // ─── 인성(印星) — 나를 키우는 성분 ───
  '편인': {
    short:  '나를 키우는 성분 · 깊은 사고',
    action: '혼자 파고드는 학습과 통찰의 성분',
    detail: '편인이 강하면 직관과 깊이가 살아나지만, 외부와 단절되기 쉬운 성분입니다.'
  },
  '정인': {
    short:  '나를 키우는 성분 · 보호·학습',
    action: '학문과 인덕으로 받쳐주는 성분',
    detail: '정인이 강하면 인덕과 학습이 강점이지만, 의존성이 함께 커지는 성분입니다.'
  }
};
