...
function buildCriticalInterpretation(cards, revFlags, domain, intent) {
  ...
  // ════════════════════════════════════════════════════════
  if (domain === "love") {
    // 연애 서브타입에 따른 미세 조정 — marriage / general
    const isMarriage = (intent === "marriage");

    // 4단락 사장님 V25.11 톤 — signal × isMarriage 매트릭스
    let loveText;

    if (signal === "BUY") {
      // 긍정적 흐름 (관계 진전 / 결혼 우호)
      loveText = isMarriage
        ? `현재 카드 흐름은 관계가 안정적인 기반 위에서 함께 만들어지는 과정에 들어섰음을 보여줍니다.\n\n다만 앞으로는 과거의 아쉬움이나 감정이 일부 정리되는 과정이 함께 나타날 수 있으며, 이 과정이 관계를 더 단단하게 만드는 계기가 될 가능성이 큽니다.\n\n결혼으로의 흐름 자체는 충분히 열려 있으나, 형식적인 진행보다 서로에 대한 이해와 합의가 먼저 선행되는 것이 중요합니다.\n\n지금은 서두르기보다는 현실적인 부분과 감정적인 부분을 함께 맞춰가는 것이 관계를 안정적으로 이어가는 데 도움이 되는 시점입니다.`
        : `현재 카드 흐름은 두 분의 관계에 새로운 가능성이 열리고 있음을 보여줍니다.\n\n다만 앞으로는 서로의 감정을 깊이 이해하는 과정이 함께 나타날 수 있으며, 이 과정이 관계를 더 따뜻하게 만드는 계기가 될 가능성이 큽니다.\n\n관계의 진전 자체는 충분히 열려 있으나, 일방적인 표현보다 서로의 마음을 살피며 함께 흐름을 만들어가는 것이 중요합니다.\n\n지금은 조급해하기보다는 진솔한 표현으로 작은 다리를 놓아가는 것이 관계를 자연스럽게 이어가는 데 도움이 되는 시점입니다.`;
    } else if (signal === "SELL") {
      // 정체/재정립 흐름
      loveText = isMarriage
        ? `현재 카드 흐름은 결혼이라는 큰 결정 앞에서 두 분이 서로의 마음을 다시 살펴볼 시점에 있음을 보여줍니다.\n\n앞으로는 그동안 미뤄두었던 의구심이나 감정이 수면 위로 떠오를 가능성이 있으며, 이를 외면하기보다 함께 마주하는 과정이 관계의 본질을 더 단단하게 만드는 계기가 될 수 있습니다.\n\n결혼으로의 흐름이 닫혀 있는 것은 아니지만, 형식적인 진행보다 서로에 대한 이해와 솔직한 합의가 먼저 자리 잡는 것이 중요합니다.\n\n지금은 결정을 서두르기보다는 두 분 사이의 본질적인 부분을 차분히 맞춰가는 것이 관계를 건강하게 이어가는 데 도움이 되는 시점입니다.`
        : `현재 카드 흐름은 관계 안에 풀어야 할 감정이나 거리감이 있음을 보여줍니다.\n\n앞으로는 그동안 쌓인 오해나 아쉬움이 수면 위로 드러날 가능성이 있으며, 이를 외면하기보다 함께 정리해가는 과정이 관계를 더 성숙하게 만드는 계기가 될 수 있습니다.\n\n관계 자체가 끝난 것은 아니지만, 무리하게 끌고 가기보다 서로의 마음을 다시 살펴보는 시간이 먼저 필요합니다.\n\n지금은 결과를 재촉하기보다는 한 발짝 물러서서 진심을 정리하는 것이 관계를 자연스럽게 이어가는 데 도움이 되는 시점입니다.`;
    } else {
      // HOLD — 관찰/탐색
      loveText = isMarriage
        ? `현재 카드 흐름은 결혼이라는 결정 앞에서 두 분이 서로의 마음과 현실을 함께 살펴보는 시기에 들어섰음을 보여줍니다.\n\n앞으로는 가치관과 미래에 대한 그림을 맞춰가는 과정이 함께 나타날 수 있으며, 이 과정이 결혼의 본질적인 합의를 단단하게 만드는 계기가 될 가능성이 큽니다.\n\n결혼으로의 흐름이 막혀 있지는 않지만, 한쪽의 결정만으로 진행하기보다 서로의 진심이 모여드는 시점을 함께 기다리는 것이 중요합니다.\n\n지금은 결정을 서두르기보다는 결혼 준비의 현실적인 부분과 감정적인 부분을 함께 맞춰가는 것이 관계를 안정적으로 이어가는 데 도움이 되는 시점입니다.`
        : `현재 카드 흐름은 두 분의 관계가 깊어지기 위한 관찰과 인내의 시기에 있음을 보여줍니다.\n\n앞으로는 서로의 진심을 천천히 확인하는 과정이 함께 나타날 수 있으며, 이 과정이 관계의 깊이를 더하는 계기가 될 가능성이 큽니다.\n\n관계의 흐름이 멈춘 것은 아니지만, 결과를 재촉하기보다 자연스러운 흐름을 따라가는 것이 중요합니다.\n\n지금은 답을 빨리 찾기보다는 두 분 사이의 작은 신호들을 함께 살펴가는 것이 관계를 따뜻하게 이어가는 데 도움이 되는 시점입니다.`;
    }

    // 면책 — 사장님 안 그대로 (관계 도메인 적합)
    const loveDisclaimer = `※ 본 해석은 두 분의 관계 흐름에 대한 참고 관점이며, 실제 관계는 두 분의 진심과 대화를 통해 함께 만들어가시기 바랍니다.`;

    return `${loveText}\n\n${loveDisclaimer}`;
  }
  // ════════════════════════════════════════════════════════
  // [V25.9.3+V25.12] 다른 도메인 — 사장님 압축형 패턴 (V25.12)
  //   사장님 진단:
  //     ① 핵심 해석 이중 구조 (criticalInterpretation + interpretText)
  //     ② 어미 반복 ("가능성이/도움이/염두에" 책임 회피 인상)
  //     ③ 핵심 해석 = 요약+결론만 (위 레이어 반복 X)
  //   해결: 3단락 압축 + 어미 5종 순환 + 사장님 정확 톤
  // ════════════════════════════════════════════════════════

  // ─ Paragraph 1: 현재 흐름 해석 (객관 톤) ─
  let para1;
  if (domain === "realestate") {
    if (intent === "sell") {
      para1 = signal === "SELL" ? `현재 흐름은 강한 매도 우위보다 호가 협상 여지가 있는 균형 구간으로 해석됩니다.`
            : signal === "BUY"  ? `현재 흐름은 매도자에게 우호적인 시장 구조로 해석됩니다.`
            : `현재 흐름은 명확한 상승 또는 하락보다 시장 방향을 탐색하는 균형 구간으로 해석됩니다.`;
    } else {
      para1 = signal === "SELL" ? `현재 흐름은 추가 가격 조정 여지가 남아 있는 구간으로 해석됩니다.`
            : signal === "BUY"  ? `현재 흐름은 매수자에게 우호적인 진입 기회가 열려 있는 구간으로 해석됩니다.`
            : `현재 흐름은 명확한 상승 또는 하락보다 시장 방향을 탐색하는 균형 구간으로 해석됩니다.`;
    }
  } else if (domain === "general") {
    // [V25.12] 운세 일반 — 가벼운 톤 (사장님 안)
    para1 = signal === "SELL" ? `현재 흐름은 정체와 정리가 함께 나타나는 전환 구간으로 해석됩니다.`
          : signal === "BUY"  ? `현재 흐름은 새로운 가능성이 열리는 확장 구간으로 해석됩니다.`
          : `현재 흐름은 방향성을 탐색하며 작은 선택이 의미를 가지는 구간으로 해석됩니다.`;
  } else {
    // stock / crypto
    if (intent === "sell") {
      para1 = signal === "SELL" ? `현재 흐름은 추세 지속보다 흐름 재평가가 우선되는 구간으로 해석됩니다.`
            : signal === "BUY"  ? `현재 흐름은 추세가 아직 유효하나 정점을 살펴야 하는 구간으로 해석됩니다.`
            : `현재 흐름은 명확한 방향보다 신호 검증이 우선되는 구간으로 해석됩니다.`;
    } else {
      para1 = signal === "SELL" ? `현재 흐름은 진입보다 관망이 우선되는 구간으로 해석됩니다.`
            : signal === "BUY"  ? `현재 흐름은 분할 진입 흐름이 유효한 구간으로 해석됩니다.`
            : `현재 흐름은 신호 검증이 우선되는 균형 구간으로 해석됩니다.`;
    }
  }

  // ─ Paragraph 2: 행동 전략 (제안 톤) ─
  let para2;
  if (domain === "realestate") {
    if (intent === "sell") {
      para2 = signal === "SELL" ? `지금은 호가 집착보다 시장 반응을 살피며 조건을 유연하게 운용하는 전략이 더 적합한 흐름입니다.`
            : signal === "BUY"  ? `지금은 시즌의 흐름을 활용해 호가를 견고하게 유지하는 접근이 더 적합한 흐름입니다.`
            : `지금은 한쪽 방향만 고집하기보다 시장 신호를 살피며 조건을 조율하는 접근이 안정적인 선택입니다.`;
    } else {
      para2 = signal === "SELL" ? `지금은 충동 진입보다 저점 신호를 확인한 뒤 접근하는 전략이 더 적합한 흐름입니다.`
            : signal === "BUY"  ? `지금은 성급한 계약보다 조건이 유리한 매물을 선별적으로 탐색하는 전략이 더 적합한 흐름입니다.`
            : `지금은 즉각 결단보다 데이터 수집과 명확한 신호 대기가 안정적인 선택입니다.`;
    }
  } else if (domain === "general") {
    para2 = signal === "SELL" ? `지금은 결과를 재촉하기보다 흐름의 정리 시간을 갖는 접근이 더 적합한 시점입니다.`
          : signal === "BUY"  ? `지금은 망설이기보다 작은 선택을 통해 흐름을 만드는 접근이 더 적합한 시점입니다.`
          : `지금은 한쪽으로 치우치기보다 자신의 기준을 정리하며 흐름을 살피는 접근이 안정적인 선택입니다.`;
  } else {
    // stock / crypto
    if (intent === "sell") {
      para2 = signal === "SELL" ? `지금은 무대응보다 포지션 일부를 점진적으로 조정하는 전략이 더 적합한 흐름입니다.`
            : signal === "BUY"  ? `지금은 성급한 일괄 정리보다 핵심 보유 유지와 분할 익절 준비가 더 적합한 흐름입니다.`
            : `지금은 한쪽 결단보다 단계적 정리와 신호 검증이 안정적인 선택입니다.`;
    } else {
      para2 = signal === "SELL" ? `지금은 무리한 진입보다 객관적 신호 확인 후 대응하는 전략이 더 적합한 흐름입니다.`
            : signal === "BUY"  ? `지금은 일괄 진입보다 분할 접근으로 추세를 따라가는 전략이 더 적합한 흐름입니다.`
            : `지금은 즉각 행동보다 신호 검증 후 단계적으로 대응하는 접근이 안정적인 선택입니다.`;
    }
  }

  // ─ Paragraph 3: 핵심 권유 (강조 톤, 사장님 안 정확 매칭) ─
  let para3;
  if (domain === "realestate") {
    para3 = intent === "buy"
      ? `특히 외부 분위기보다 자신의 기준과 자금 계획을 우선 유지하는 것이 중요하며, 명확한 가격 메리트가 확인될 때 접근하는 것이 안정적인 선택으로 볼 수 있습니다.`
      : `특히 단기 호가 변동보다 자신의 매도 기준과 시즌 흐름을 우선 살피는 것이 중요하며, 시장의 분명한 반응이 확인될 때 조정하는 것이 안정적인 선택으로 볼 수 있습니다.`;
  } else if (domain === "general") {
    para3 = `특히 주변 의견보다 자신의 기준과 가치관을 우선하는 것이 흐름을 안정시키며, 작은 선택의 결이 모여 향후 흐름의 방향을 결정합니다.`;
  } else if (domain === "stock" || domain === "crypto") {
    para3 = intent === "sell"
      ? `특히 변동성이 동반될 가능성이 있는 구간이므로, 흐름 점검 없이 유지하기보다 단계적 대응이 안정적인 선택으로 볼 수 있습니다.`
      : `특히 변동성이 동반될 가능성이 있는 구간이므로, 초기 진입은 신중하게 접근하고 추세 확인 이후 대응하는 것이 안정적인 선택으로 볼 수 있습니다.`;
  } else {
    para3 = `특히 외부보다 자신의 흐름을 우선 살피는 것이 중요하며, 명확한 신호가 확인될 때 행동하는 것이 안정적인 선택으로 볼 수 있습니다.`;
  }

  // ─ 면책 (도메인별 차별화 — 사장님 안 정확) ─
  const disclaimer = (domain === "stock" || domain === "crypto")
    ...
    : domain === "general"
    ? `※ 본 신탁은 흐름 해석을 돕기 위한 참고 콘텐츠입니다. 중요한 결정은 개인의 상황에 맞게 신중히 판단하시기 바랍니다.`
    : `※ 본 신탁은 흐름에 대한 참고 콘텐츠입니다. 실제 판단은 본인의 상황과 함께 신중히 고려하시기 바랍니다.`;
